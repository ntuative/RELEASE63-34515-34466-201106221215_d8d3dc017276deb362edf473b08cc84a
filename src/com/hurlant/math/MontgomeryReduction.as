package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2042 = param1.invDigit();
         this.var_2043 = this.var_2042 & 32767;
         this.var_2813 = this.var_2042 >> 15;
         this.var_2814 = 131071;
         this.var_2812 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_183) > 0)
         {
