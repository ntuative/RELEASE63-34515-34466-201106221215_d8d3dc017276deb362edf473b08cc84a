package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_607:uint = 0;
      
      protected static var var_560:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_560 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            ...
            this.var_1487 = BitmapDataAsset(this.var_119).var_1487;
            this.var_1486 = BitmapDataAsset(this.var_119).var_1486;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
