package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1388:String = "AssetLibraryReady";
      
      public static const const_862:String = "AssetLibraryLoaded";
      
      public static const const_1994:String = "AssetLibraryUnloaded";
      
      public static const const_2016:String = "AssetLibraryLoadError";
      
      private static const const_684:String = "name";
      
      private static const const_1077:String = "asset";
      
      private static const const_1079:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1078:String = "library";
      
      private static var var_325:Dictionary;
      
      private static var var_1895:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_543 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1078);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1077);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_684);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1079);
                  if(_loc11_.length())
                  {
      ...
      {
         if(this.var_640 == param1.url && this.var_1004)
         {
            if(!this.var_1003 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_639);
            }
      ...
      public function unload() : void
      {
         ...
         this.var_1004 = false;
         this.var_640 = null;
         dispatchEvent(new Event(AssetLibrary.const_1994));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_543[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1238,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1402,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_543[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_543[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_543[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_171[param1] != null || (this.var_639 != null ? this.var_639[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1895.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_325.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_325[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_461.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_461[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_325[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_461[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_325)
            {
               _loc3_ = AssetTypeDeclaration(var_325[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_461)
         {
            _loc3_ = AssetTypeDeclaration(this.var_461[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_325)
            {
               _loc4_ = AssetTypeDeclaration(var_325[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_461)
         {
            _loc4_ = AssetTypeDeclaration(this.var_461[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_1004 = true;
         dispatchEvent(new Event(AssetLibrary.const_862));
         dispatchEvent(new Event(AssetLibrary.const_1388));
         if(this.var_1003)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_2016));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1078);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1077);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_684) && _loc3_.attribute(const_684).toString() == param1)
                  {
                     ...
                     _loc5_.setUnknownContent(this.var_639[param1]);
                     _loc6_ = _loc3_.child(const_1079);
