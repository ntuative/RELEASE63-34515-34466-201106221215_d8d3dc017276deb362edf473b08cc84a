package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1148 = new LoaderContext();
         this.var_1148.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1148);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_357 = 0;
         this.var_45.load(param1,this.var_1148);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_357 < var_3039)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1141 + (this.var_1141.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_357),this.var_1148);
               return true;
            }
         }
         return false;
