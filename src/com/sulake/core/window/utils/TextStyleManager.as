package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_214:String = "regular";
      ...
      private static var var_555:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_702:String = "{";
      
      private static const const_701:String = "}";
      
      private static const const_1576:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_97[const_214],var_97[ITALIC],var_97[BOLD]];
            var_97.reset();
            var_97[const_214] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_555.indexOf(_loc4_.name) == -1)
            {
               var_555.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_701);
         if(countSubStrings(param1,const_702) != countSubStrings(param1,const_701))
         {
            throw new Error("Mismatching amount of \"" + const_702 + "\" versus \"" + const_701 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1576) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1575) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_702)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
