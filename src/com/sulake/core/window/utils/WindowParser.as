package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2311:String = "_INCLUDE";
      
      public static const const_2274:String = "_TEMP";
      
      private static const const_1442:String = "layout";
      
      private static const const_1043:String = "window";
      
      private static const const_1042:String = "variables";
      
      private static const const_1044:String = "filters";
      
      private static const const_684:String = "name";
      
      private static const const_1448:String = "style";
      
      private static const const_683:String = "params";
      
      private static const const_1443:String = "tags";
      ...
      private static const const_1444:String = "visible";
      
      private static const const_1450:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1186:String = "blend";
      
      private static const const_1451:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1440:String = "treshold";
      
      private static const const_1437:String = "children";
      
      private static const const_1447:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1438:String = "height_min";
      
      private static const const_1445:String = "height_max";
      
      private static const const_682:String = "true";
      
      private static const const_183:String = "0";
      ...
      private static const const_1446:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1439:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1402:Dictionary;
      
      protected var var_1403:Dictionary;
      
      protected var var_1136:Dictionary;
      
      protected var var_1694:Dictionary;
      
      protected var var_2232:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1402 = new Dictionary();
         this.var_1403 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1402,this.var_1403);
         this.var_1136 = new Dictionary();
         this.var_1694 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1136,this.var_1694);
         this.var_2232 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1439,const_50);
         return param1.replace(const_1446,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1402)
            {
               delete this.var_1402[_loc1_];
            }
            for(_loc1_ in this.var_1403)
            {
               delete this.var_1403[_loc1_];
            }
            for(_loc1_ in this.var_1136)
            {
               delete this.var_1136[_loc1_];
            }
            for(_loc1_ in this.var_1694)
            {
               delete this.var_1694[_loc1_];
            }
            this.var_2232.dispose();
            this.var_2232 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1442)
         {
            _loc8_ = param1.child(const_1042);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1044).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1043);
         ...
         if(param1.localName() == const_1043)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1402[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_684,variables,"")));
         style = uint(this.parseAttribute(xml,const_1448,variables,style));
         params = uint(this.parseAttribute(xml,const_683,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1443,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_183));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_183));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_183));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_183));
         visible = this.parseAttribute(xml,const_1444,variables,visible.toString()) == const_682;
         ...
         if(xml.child(const_683).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_684,variables,"") as String;
               if(this.var_1136[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_684)) + "\"!");
               }
               params |= this.var_1136[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1450,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1449);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1042)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1447,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1438,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1445,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_682;
         blend = Number(this.parseAttribute(xml,const_1186,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1451,variables,window.clipping.toString()) == const_682;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1440,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1044).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_220)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1403[param1.type];
