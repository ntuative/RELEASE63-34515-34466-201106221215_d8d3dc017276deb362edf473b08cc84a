package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_747:Point;
      
      protected var var_1443:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_747);
         this._window.offset(this.var_747.x - this._offset.x,this.var_747.y - this._offset.y);
      }
