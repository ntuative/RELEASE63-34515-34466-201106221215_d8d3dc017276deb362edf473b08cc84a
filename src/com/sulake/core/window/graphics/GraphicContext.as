package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2118:uint = 64;
      
      public static const const_2286:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_608:uint = 0;
      
      protected static var var_361:uint = 0;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_208)
            {
               this.var_208 = new Shape();
               this.var_208.visible = false;
               this.var_208.cacheAsBitmap = true;
               super.addChild(this.var_208);
            }
            this.var_208.graphics.clear();
            this.var_208.graphics.beginFill(255);
            this.var_208.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_208.graphics.endFill();
            this.getDisplayObject().mask = this.var_208;
         }
         else if(this.var_208)
         {
            super.removeChild(this.var_208);
            this.var_208.graphics.clear();
            this.var_208 = null;
         ...
         if(this.var_928)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_361 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2256,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2256,16777215);
                  }
                  var_361 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_928)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_361 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
