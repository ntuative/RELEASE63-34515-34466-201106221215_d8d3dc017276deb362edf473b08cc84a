   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_355 = SkinLayoutEntity.const_647;
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_329;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_597;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_374;
                  break;
               case "center":
                  _loc5_.var_355 = SkinLayoutEntity.const_505;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_354 = SkinLayoutEntity.const_647;
                  break;
               case "move":
                  _loc5_.var_354 = SkinLayoutEntity.const_329;
                  break;
               case "strech":
                  _loc5_.var_354 = SkinLayoutEntity.const_597;
                  break;
               case "tiled":
                  _loc5_.var_354 = SkinLayoutEntity.const_374;
                  break;
               case "center":
                  _loc5_.var_354 = SkinLayoutEntity.const_505;
            }
         }
