package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1127:uint = 1;
      
      private static const const_1128:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1619 = 4294967295;
         this.var_1082 = 0;
         this.var_773 = new ColorTransform();
         this.var_1135 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1128) : uint(const_717);
         var _loc6_:Boolean = this.var_199.width > 0 && this.var_199.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1082))
            {
               _loc5_ = const_1127;
            }
         }
         ...
         if(_loc5_ != const_717)
         {
            this.var_1619 = this.var_1082;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1127)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_689)
                  {
                     ...
                     _loc7_.draw(param1,this.var_135,this.var_135.rect,this.var_1082,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1135.tx = param2.x;
                     this.var_1135.ty = param2.y;
                     this.var_773.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_135,this.var_1135,this.var_773,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1619;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1333:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1020:
               this.var_1082 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1082 != this.var_1619)
               {
                  this.var_689 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1186:
               ...
               break;
            case WindowRedrawFlag.const_1376:
               _loc4_ = true;
         }
         if(_loc4_)
         {
