package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      {
         super(param1);
         this.var_923 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_271 = null;
            this.var_773 = null;
            for(_loc1_ in this.var_923)
            {
               _loc2_ = this.var_923[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_923[_loc1_];
            }
            this.var_923 = null;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.var_355 == SkinLayoutEntity.const_329)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_597)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_374)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_505)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_354 == SkinLayoutEntity.const_329)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_597)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_374)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_505)
                  {
                  ...
                  else if(_loc10_.var_354 == SkinLayoutEntity.const_374 || _loc10_.var_355 == SkinLayoutEntity.const_374)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_355 == SkinLayoutEntity.const_329)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_354 == SkinLayoutEntity.const_329)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_923[_loc3_];
         if(_loc4_ == null)
         {
