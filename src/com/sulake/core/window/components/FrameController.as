package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1598:String = "_TITLE";
      
      private static const const_1599:String = "_HEADER";
      
      private static const const_1597:String = "_CONTENT";
      
      private static const const_1600:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1555:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1598) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1555 = findChildByTag(const_1599) as IHeaderWindow;
            if(!this.var_1555)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_193 = findChildByTag(const_1597) as IWindowContainer;
            if(!this.var_193)
            {
      ...
      {
         return findChildByTag(const_1600) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_358);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_297);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_280);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_297,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_297,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_280,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_280,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_357,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,_loc3_.left,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,_loc3_.top,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_316,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         return _loc1_;
      }
