package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2075:String = "_POINTER_UP";
      
      private static const const_2077:String = "_POINTER_DOWN";
      
      private static const const_2076:String = "_POINTER_LEFT";
      
      private static const const_2078:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_844;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_979,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2003);
         }
         if(this.var_844 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_908,this.var_844,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1736);
         }
         return _loc1_;
      }
