package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1521:String = "_SELECTOR";
      
      private static const const_1522:String = "_CONTENT";
       
      
      protected var var_1140:ITabSelectorWindow;
      
      protected var var_2235:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1140 = findChildByTag(const_1521) as ITabSelectorWindow;
            if(this.var_1140 != null)
            {
               this.var_1140.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2235 == null)
         {
            this.var_2235 = findChildByTag(const_1522) as IWindowContainer;
         }
      ...
      {
         return !!this.var_842 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1140.numSelectables;
      }
