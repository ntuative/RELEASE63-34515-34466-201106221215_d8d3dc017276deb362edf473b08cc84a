package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1705:String = "increment";
      
      private static const const_1706:String = "decrement";
      
      private static const const_1154:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_189 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_616;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_611,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_611,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1115 = _loc3_.value as String;
               this.var_19 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1154) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_730:
               if(param2.type == WindowEvent.const_230)
               {
                  if(!this.var_1384)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_652)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_332)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_749;
                  }
                  else
                  {
                     this.scrollV -= this.var_749;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_900)
         {
            ...
            else if(param2.name == const_1706)
            {
               if(this.var_19)
               {
                  this.var_1384 = true;
            ...
            else if(param2.name == const_1154)
            {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1115) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1115) as IScrollableWindow;
               if(_loc1_)
               {
