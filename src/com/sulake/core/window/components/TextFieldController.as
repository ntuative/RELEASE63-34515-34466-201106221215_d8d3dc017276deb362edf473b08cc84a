package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1695:uint = 500;
      ...
      {
         this.var_1405 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_TEXTFIELD,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_842 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_409,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_341,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_111,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_831,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1800);
         _loc1_.push(this.var_1404 != PropertyDefaults.const_1278 ? new PropertyStruct(PropertyDefaults.const_815,this.var_1404,PropertyStruct.const_35,true) : PropertyDefaults.const_1879);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1382 ? new PropertyStruct(PropertyDefaults.const_971,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1890);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1337 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1945);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_831:
                  ...
                  break;
               case PropertyDefaults.const_1241:
