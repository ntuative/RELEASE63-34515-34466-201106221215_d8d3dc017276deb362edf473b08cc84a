package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1836:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1221 == param2)
         {
            return;
         }
         param1.var_1221 = param2;
         param1.var_1836 = null;
         if(param1.var_1221 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1221);
            param1.var_1836 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_922.indexOf(param1) > -1)
         {
            this.var_795 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1836;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1375)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_834,this.var_795,PropertyStruct.const_51,true,PropertyDefaults.const_922));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_834)
            {
