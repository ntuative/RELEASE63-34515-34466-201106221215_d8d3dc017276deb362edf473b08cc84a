package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         else if(param2.type == WindowEvent.const_1273)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_921;
         if(this.var_921 != param1)
         {
            if(this.var_921 != null)
            {
               if(!this.var_921.disposed)
               {
                  this.var_921.deactivate();
               }
            }
            this.var_921 = param1;
