package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_568)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_568)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_880,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1776);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1248)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_842,param1.toolTipDelay,PropertyStruct.const_303,true));
         }
         else
         {
      ...
      {
         this.var_1405 = param1 == null ? "null" : param1;
      }
