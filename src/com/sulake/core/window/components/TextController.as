package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_929:Number;
      
      protected var var_602:Number;
      
      protected var var_603:Boolean;
      ...
      private var var_482:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_482,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_482 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_482,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_214);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_846 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_482);
      }
      ...
      {
         this.var_929 = param1;
         this._field.scrollH = this.var_929 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_929 * this.maxScrollH,this.var_602 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_482);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_749,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1197));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1350 ? new PropertyStruct(PropertyDefaults.const_733,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1259) : PropertyDefaults.const_1817);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_35,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_167,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1299 ? new PropertyStruct(PropertyDefaults.const_1400,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1214) : PropertyDefaults.const_1775);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_806) ? new PropertyStruct(PropertyDefaults.const_400,this._field.textColor,PropertyStruct.const_167,true) : PropertyDefaults.const_1339);
         _loc1_.push(this.var_482 != TextStyleManager.const_214 ? new PropertyStruct(PropertyDefaults.const_455,this.var_482,PropertyStruct.const_51,true,PropertyDefaults.const_970) : PropertyDefaults.const_1246);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_999 ? new PropertyStruct(PropertyDefaults.const_253,this.var_42.left,PropertyStruct.const_38,true) : PropertyDefaults.const_845);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_930 ? new PropertyStruct(PropertyDefaults.const_277,this.var_42.top,PropertyStruct.const_38,true) : PropertyDefaults.const_913);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_812 ? new PropertyStruct(PropertyDefaults.const_266,this.var_42.right,PropertyStruct.const_38,true) : PropertyDefaults.const_911);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_843 ? new PropertyStruct(PropertyDefaults.const_316,this.var_42.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_863);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1195 ? new PropertyStruct(PropertyDefaults.const_943,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1957);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_127,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_127,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_127,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
