package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1405:Number = 0.5;
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_272:
                  try
                  {
                     getChildByName(const_464).blend = getChildByName(const_464).blend + const_1405;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_307:
                  try
                  {
                     getChildByName(const_464).blend = getChildByName(const_464).blend - const_1405;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1185:
                  type = "null";
                  break;
               case WindowTouchEvent.const_900:
                  type = "null";
            }
