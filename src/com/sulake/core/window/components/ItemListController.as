package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_745:Number;
      
      protected var var_746:Number;
      
      protected var var_123:Number;
      
      protected var var_108:Number;
      
      protected var _container:IWindowContainer;
      
      protected var var_2244:Boolean = false;
      ...
      protected var var_744:Number = -1.0;
      
      protected var var_743:Number = -1.0;
      ...
      protected var var_2243:int = 0;
      
      protected var var_2242:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_123 = 0;
         this.var_108 = 0;
         this._horizontal = param2 == WindowType.const_426;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_189 = var_511 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_434,WindowStyle.const_104,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_432,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_148,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_230,this.containerEventHandler);
      ...
      {
         return Math.max(0,this.var_123 - width);
      }
      ...
      {
         return new Rectangle(this.var_745 * this.maxScrollH,this.var_746 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_745 = param1;
            this._container.x = -this.var_745 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_611,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_746)
         {
            this.var_746 = param1;
            this._container.y = -this.var_746 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_611,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_432,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_148,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_230,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_123 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_123 = param1.rectangle.right;
            this._container.width = this.var_123;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1413)
               {
                  this.var_1416 = this.var_2243 - _loc3_;
                  this.var_1415 = this.var_2242 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1416 != 0 && this.var_123 != 0)
                     {
                        this.scrollH += this.var_1416 / this.var_123;
                     }
                  }
            ...
            case WindowMouseEvent.const_248:
               if(this.var_1413)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1416,0);
                  }
                  else
                  {
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_123;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1143 && !this.var_600 && this._container)
         {
            this.var_600 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_123;
                     this.var_123 += _loc2_.width + this._spacing;
                     if(this.var_506)
                     {
               ...
               if(_loc1_ > 0)
               {
                  this.var_123 -= this._spacing;
               }
            }
            else
            {
               this.var_123 = var_11.width;
               this.var_108 = 0;
               _loc4_ = 0;
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_506)
                     {
                        ...
                        this.var_123 = _loc3_ > this.var_123 ? Number(_loc3_) : Number(this.var_123);
                     }
                  }
                  _loc4_++;
               }
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_839)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_446,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1302);
         }
         if(this.var_1143 != PropertyDefaults.const_1265)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_779,this.var_1143,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1845);
         }
         if(this.var_506 != PropertyDefaults.const_1317)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_753,this.var_506,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1932);
         }
         if(this.var_1414 != PropertyDefaults.const_1164)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_914,this.var_1414,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1810);
         }
         if(this.var_744 != PropertyDefaults.const_1232)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_954,this.var_744,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1849);
         }
         if(this.var_743 != PropertyDefaults.const_1237)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_919,this.var_743,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1852);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_446:
               ...
               case PropertyDefaults.const_954:
                  this.var_744 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_919:
                  this.var_743 = _loc2_.value as Number;
                  break;
            }
         }
