package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_482);
         if(_loc1_)
         {
      ...
      {
         if(this.var_482 != param1.name)
         {
            this.var_482 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2534 = _loc2_.textWidth;
         this.var_2535 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_386 != _loc2_.color : this.var_386 != null && this.var_386 != PropertyDefaults.const_806) ? new PropertyStruct(PropertyDefaults.const_400,this.var_386,PropertyStruct.const_167,true) : PropertyDefaults.const_1339);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_999)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,this.var_42.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_845);
            }
            if(this.var_42.top != PropertyDefaults.const_930)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,this.var_42.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_913);
            }
            if(this.var_42.right != PropertyDefaults.const_812)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,this.var_42.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_911);
            }
            if(this.var_42.bottom != PropertyDefaults.const_843)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_316,this.var_42.bottom,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_863);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_266:
                  ...
                  break;
               case PropertyDefaults.const_316:
                  if(this.var_42 || _loc2_.valid)
                  {
