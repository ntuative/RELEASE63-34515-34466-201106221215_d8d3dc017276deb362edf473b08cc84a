package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1204:IItemListWindow;
      
      private var var_454:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_454)
         {
            this.var_454.removeEventListener(WindowEvent.const_272,this.scrollBarEventProc);
            this.var_454.removeEventListener(WindowEvent.const_307,this.scrollBarEventProc);
            this.var_454 = null;
         }
         if(this.var_1204)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1204)
         {
            this.var_1204 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_454)
         {
            this.var_454 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_454)
            {
               this.var_454.addEventListener(WindowEvent.const_272,this.scrollBarEventProc);
               this.var_454.addEventListener(WindowEvent.const_307,this.scrollBarEventProc);
            }
         }
         return this.var_454;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_307)
         {
            this.hideScrollBar();
         }
      }
