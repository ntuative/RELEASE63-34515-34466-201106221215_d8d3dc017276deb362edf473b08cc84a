package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_936[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2279);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_190));
         }
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1712);
         }
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1154)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_76)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1712);
            }
         }
      }
   }
