package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1436:String = "asset-libraries";
      
      private static const const_1434:String = "library";
      
      private static const const_1432:String = "service-libraries";
      
      private static const const_1429:String = "library";
      
      private static const const_1428:String = "component-libraries";
      
      private static const const_1433:String = "library";
      
      private static const const_1435:String = "error_data";
      
      private static const const_1431:String = "error_cat";
      ...
      private var var_756:IEventDispatcher;
      
      private var var_521:uint;
      
      private var var_365:Function;
      
      private var var_209:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_840:
               ...
               this.var_209 = new Profiler(this);
               attachComponent(this.var_209,[new IIDProfiler()]);
               var_428.addChild(new ProfilerViewer(this.var_209));
               break;
            case Core.const_666:
      ...
      {
         return this.var_521 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1435,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1431,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_756 = loadingEventDelegate;
         if(this.var_364 == null)
         {
         ...
         try
         {
            node = config.child(const_1432)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1428)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1282);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_756)
         {
            this.var_756.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_756)
         {
            ...
            this.var_756.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_756)
                  {
                     this.var_756.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_521 - this.var_364.length,this.var_521,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_209 ? 0 : this.var_1443 & 0;
         if(_loc3_ == Core.const_666)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_615[priority] < priority)
               {
                  ++this.var_615[priority];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_209.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_209)
            {
               detachComponent(this.var_209);
               this.var_209.dispose();
               this.var_209 = null;
            }
            switch(this.var_1443 & 0)
            {
               case Core.const_1291:
                  this.var_365 = this.simpleFrameUpdateHandler;
                  break;
