package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1947:int = 4;
      ...
      {
         return this.var_459.length + this.var_309.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_309.length < const_1947 && this.var_459.length > 0)
            {
               _loc1_ = this.var_459.shift();
               this.var_309.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            ...
            index = this.var_309.indexOf(loader);
            if(index > -1)
            {
               this.var_309.splice(index,1);
            }
         }
         catch(e:Error)
         {
