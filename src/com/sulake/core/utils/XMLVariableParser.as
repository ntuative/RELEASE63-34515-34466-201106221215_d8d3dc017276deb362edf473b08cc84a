package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1837:String = "float";
      
      public static const const_35:String = "Boolean";
      
      public static const const_1858:String = "bool";
      ...
      private static const const_719:String = "value";
      
      private static const const_682:String = "true";
      
      private static const const_2082:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_719));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_719)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_290 || _loc5_ == const_177)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_167:
               return uint(param1);
            case const_177:
               return param1.split(const_1449);
            default:
