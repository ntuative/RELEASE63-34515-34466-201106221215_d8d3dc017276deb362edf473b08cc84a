package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1400:IWindowContainer;
      
      public static var var_1690:IWindowContainer;
      
      public static var var_2225:int = 6710886;
      
      private static const const_1718:int = 5000;
      
      private static const const_1458:Point = new Point(100,30);
      ...
      private var var_262:ITabSelectorWindow;
      ...
      private var var_3002:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1391 = [];
         this.var_1653 = [AvatarEditorFigureCategory.const_893,AvatarEditorFigureCategory.const_58,AvatarEditorFigureCategory.const_259,AvatarEditorFigureCategory.const_803,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_117];
         super();
         this.var_24 = param1;
         if(var_1400 == null)
         {
            _loc4_ = this.var_24.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1400 = this.var_24.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1690 == null)
         {
            _loc5_ = this.var_24.manager.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1690 = this.var_24.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this._saveTimer = new Timer(const_1718,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1653;
         }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         if(_loc3_)
         {
            this.var_90 = this.var_24.manager.windowManager.buildFromXML(_loc3_.content as XML) as IFrameWindow;
         }
         if(this.var_90 == null)
         {
         ...
         this.var_90.position = const_1458;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_737 == null)
            {
               this.var_737 = this.var_24.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_70,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_737.addChild(this.var_61);
            }
            _loc3_ = this.var_737.getChildIndex(this.var_61);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1653);
         }
         if(param1.length != this.var_1391.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1391.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         if(this.var_61 == null)
         {
            this.var_61 = this.var_24.manager.windowManager.buildFromXML((this.var_24.manager.assets.getAssetByName("AvatarEditorContent") as XmlAsset).content as XML) as IWindowContainer;
         }
         this.var_61.procedure = this.windowEventProc;
         this.var_262 = this.var_61.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_262.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_262.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1391.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_262.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_262.numSelectables)
               {
                  this.var_262.getSelectableAt(_loc4_).x = this.var_262.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_262.setSelected(this.var_262.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1653;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_36 && this.var_24.isSideContentEnabled();
         }
         var _loc4_:String = "null";
         if(this.var_24.manager.sessionData && this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_36 && (this.var_1687 == AvatarEditorSideCategory.const_117 || this.var_3002))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_404);
      }
      ...
      {
         if(this.var_1687 == AvatarEditorSideCategory.const_117)
         {
            this.var_3002 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_675:
               break;
            case AvatarEditorSideCategory.const_615:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_615);
               break;
            case AvatarEditorSideCategory.const_117:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_117);
         }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_404 = param1;
         this.var_262.setSelected(this.var_262.getSelectableByName(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_350)
         {
            ...
            this.var_350 = this.var_24.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_24.manager.catalog.openCatalogPage(CatalogPageName.const_136,true);
         }
      }
   }
}
