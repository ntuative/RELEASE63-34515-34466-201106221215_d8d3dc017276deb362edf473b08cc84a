package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1607:String = "Default";
      
      private static const const_1605:int = 2;
      
      private static const const_1606:String = AvatarSetType.const_41;
      ...
      protected var var_310:IActiveActionData;
      ...
      private var var_2806:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_304 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1606,const_1605);
         this.var_358 = new Array();
         this.var_1052 = new ActiveActionData(AvatarAction.const_457);
         this.var_1052.definition = this._structure.getActionDefinition(const_1607);
         this.resetActions();
      ...
      {
         param2 += this.var_1983;
         if(param2 < AvatarDirectionAngle.const_1329)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_682,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_292.length == 1 && this.var_101 == this.var_2083)
         {
            return this.var_101 + this.var_574 + this.var_682 % 4;
         }
         if(this.var_292.length == 2)
         {
            for each(_loc1_ in this.var_292)
            {
               ...
               {
                  return this.var_101 + this.var_574 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_682 % 11;
                  return this.var_101 + "_" + this.var_2083 + this.var_574 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2807 || param2 != this.var_2806 || param1 != this.var_2808)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_310.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1422 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1422)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_310.definition.geometryType,this.var_101);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_682);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_310.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_310.definition.geometryType,this.var_101);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_682);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_358.length)
         {
            _loc3_ = this.var_358[_loc4_];
         ...
         this.var_358.push(new ActiveActionData(param1,param2,this.var_682));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_310 = this.var_1052;
         this.var_310.definition = this.var_1052.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_574 = "";
         this.var_292 = this._structure.sortActions(this.var_358);
         if(this.var_292 == null)
         {
            this.var_760 = new Array(0,0,0);
            if(this.var_1328 != "")
            {
               _loc1_ = true;
               this.var_1328 = "";
         ...
         {
            this.var_760 = this._structure.getCanvasOffsets(this.var_292,this._scale,this.var_101);
            for each(_loc4_ in this.var_292)
            {
               this.var_574 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_379)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1608 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1608 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1328 != this.var_574)
            {
               _loc1_ = true;
               this.var_1328 = this.var_574;
            }
         }
         this.var_1564 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_292)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1018 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1983 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_367 || _loc1_.actionType == AvatarAction.const_278 || _loc1_.actionType == AvatarAction.const_440)
               {
                  this.var_1018 = true;
               }
            }
