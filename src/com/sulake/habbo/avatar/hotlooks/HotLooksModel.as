package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_2248:String = "hot_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         this.var_584["null"] = new Array();
         this.var_584["null"] = new Array();
         this.var_584["undefined.index"] = 0;
         this.var_584["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_584["null"];
      ...
      {
         return this.var_584["null"];
      }
      
      private function requestHotLooks() : void
      {
         var _loc1_:String = var_28.manager.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_28.manager.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_28.manager.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_584[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
