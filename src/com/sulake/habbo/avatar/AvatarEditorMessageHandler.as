package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorMessageHandler
   {
      ...
      private var var_28:HabboAvatarEditorManager;
      ...
      {
         if(param1 == null || !this.var_28)
         {
            return;
         }
         var _loc2_:HabboAvatarEditor = this.var_28.getEditor(AvatarEditorInstanceId.const_225);
         if(_loc2_)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.clubMemberLevel = this.var_28.sessionData.clubLevel;
            _loc2_.update();
         }
      }
   }
