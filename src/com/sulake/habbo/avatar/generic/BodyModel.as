package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         var _loc4_:CategoryData = var_116[param1];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_28.figureData.getPartSetId(FigureData.const_92);
         var _loc3_:Array = var_28.figureData.getColourIds(FigureData.const_92);
         var _loc4_:CategoryData = var_116[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         for each(_loc5_ in _loc4_.parts)
         {
            ...
            _loc7_ = var_28.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_61,null,this);
