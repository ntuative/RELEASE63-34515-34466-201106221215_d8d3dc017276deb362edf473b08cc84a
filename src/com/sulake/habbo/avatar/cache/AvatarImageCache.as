package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2091:int = 60000;
      ...
      private var var_424:IActiveActionData;
      
      private var var_474:AvatarImageBodyPartContainer;
      
      private var var_1678:String;
      
      private var var_140:AvatarImagePartContainer;
      
      private var var_2973:Point;
      ...
      private var var_2974:ByteArray;
      
      private var var_2972:ImageData;
      
      private var var_1062:PaletteMap;
      
      private var var_1123:Array;
      
      private var var_1124:Point;
      ...
      {
         if(this.var_908 == param1)
         {
            return;
         }
         if(this.var_908 == GeometryType.const_1187 && param1 == GeometryType.const_1207 || this.var_908 == GeometryType.const_1207 && param1 == GeometryType.const_1187)
         {
            this.var_908 = param1;
            this.var_98 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_424 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_424;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_424 || !this.var_424.definition))
         {
            if(this.var_424.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_424.definition.state + "." + this.var_424.actionParameter);
               _loc13_ = param2 - this.var_424.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_424.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_424 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_897)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_551)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1571.getFigure(),_loc5_,this.var_908,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_474 = _loc10_.getImageContainer(_loc4_);
         if(this.var_474 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_474 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_424);
            if(this.var_474 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_474,_loc4_);
         }
         this.var_474.offset = _loc8_;
         return this.var_474;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_98)
         {
            this.var_98 = this._structure.getCanvas(this._scale,this.var_908);
            if(!this.var_98)
            {
               return null;
            }
            this.var_2973 = new Point(0,this.var_98.height - int(this.var_98.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_837 || _loc10_ == AvatarAction.const_440;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1678 = this.var_140.bodyPartId;
               this.var_206 = this.var_140.partType;
               this.var_2157 = this.var_140.partId;
               ...
               this.var_1679 = this._scale + "_" + this.var_140.action.assetPartDefinition + "_" + this.var_206 + "_" + this.var_2157 + "_" + _loc5_ + "_" + this._frame;
               this.var_500 = this._assets.getAssetByName(this.var_1679) as BitmapDataAsset;
               if(this.var_500 == null)
               {
                  this.var_1679 = this._scale + "_std_" + this.var_206 + "_" + this.var_2157 + "_" + _loc5_ + "_0";
                  this.var_500 = this._assets.getAssetByName(this.var_1679) as BitmapDataAsset;
               }
               if(!(!this.var_500 || !this.var_500.content))
               {
                  if(this.var_140.paletteMapId > -1)
                  {
                     this.var_1062 = this._structure.renderManager.paletteManager.getPalette(this.var_140.paletteMapId);
                     if(this.var_1062 != null)
                     {
                        this.var_1125 = this.var_500.content as BitmapData;
                        this.var_205 = new BitmapData(this.var_1125.width,this.var_1125.height);
                        this.var_2974 = this.var_1062.colorize(this.var_1125.getPixels(this.var_1125.rect));
                        this.var_205.setPixels(this.var_205.rect,this.var_2974);
                     }
                     else
                     {
                        this.var_205 = (this.var_500.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1678 == AvatarBodyPartType.const_259 || this.var_1678 == AvatarBodyPartType.const_1765 || this.var_1678 == AvatarBodyPartType.const_1759) && this.var_140.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_205.colorTransform(this.var_205.rect,this.var_140.color.colorTransform);
                  }
                  if(this.var_140.isBlendable)
                  {
                     this.var_205.colorTransform(this.var_205.rect,this.var_140.blendTransform);
                  }
                  this.var_1124 = this.var_500.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2972 = new ImageData(this.var_205,this.var_1124,_loc7_);
                  this.var_1123.push(this.var_2972);
               }
            }
            _loc8_--;
         }
         if(this.var_1123.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1123,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2973.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_1123.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1123.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
