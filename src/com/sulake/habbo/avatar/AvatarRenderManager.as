package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_329:PetDataManager;
      
      private var var_822:PaletteManager;
      
      private var var_729:String;
      
      private var var_328:Map;
      
      private var var_250:AvatarAssetDownloadManager;
      
      private var var_1938:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_729 = RenderMode.const_1809;
         ...
         this.var_120.add(AvatarType.const_128,_loc4_);
         ...
         this.var_120.add(AvatarType.const_57,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_329 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_822 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_329.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_250)
         {
            this.var_250.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_329.init();
         this.var_822.init();
         _loc2_ = this.var_120.getValue(AvatarType.const_128) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_120.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_120.getValue(AvatarType.const_128) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_160.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_250 == null)
               {
                  ...
                  _loc6_ = this.var_160.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_160.getKey("flash.dynamic.avatar.download.url","");
                  this.var_250 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_250.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1004)
         {
            if(this.var_2593 && this.var_2591 && this.var_2592)
            {
               this.var_1004 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_250.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_250.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_120.getValue(AvatarType.const_128) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_250.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1938)
         {
            this.var_1938 = new AvatarFigureContainer(this.const_2348);
         }
         this.var_250.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1938,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_329.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1840)
         {
            _loc6_ = !this.var_329.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_329.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_120.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_329.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_120.getValue(AvatarType.const_57);
      ...
      {
         var _loc3_:AvatarStructure = this.var_120.getValue(AvatarType.const_128) as AvatarStructure;
      ...
      {
         return this.var_329 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_120.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
