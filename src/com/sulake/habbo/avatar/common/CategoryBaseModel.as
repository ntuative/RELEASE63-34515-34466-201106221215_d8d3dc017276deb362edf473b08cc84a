package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:CategoryData = this.var_116[param1];
         if(_loc2_ == null)
         {
            _loc3_ = this.var_28.generateDataContent(this,param1);
            if(_loc3_)
            {
               this.var_116[param1] = _loc3_;
      ...
      {
         if(!this.var_116 || !this.var_28 || !this.var_28.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_116[param1];
         ...
         var _loc3_:int = this.var_28.figureData.getPartSetId(param1);
         var _loc4_:Array = this.var_28.figureData.getColourIds(param1);
         if(!_loc4_)
         {
            _loc4_ = new Array();
         }
      ...
      public function hasClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         for each(_loc3_ in this.var_116)
         {
            if(_loc3_)
            {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_116.getKeys();
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               if(_loc8_ && this.var_28 && this.var_28.figureData && _loc6_)
               {
                  this.var_28.figureData.savePartData(_loc5_,_loc8_.id,_loc6_.getSelectedColorIds(),true);
               }
               _loc3_ = true;
            }
            _loc4_++;
      ...
      {
         var _loc3_:CategoryData = this.var_116[param1];
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(this.var_28 && this.var_28.figureData)
         {
            this.var_28.figureData.savePartData(param1,_loc4_.id,_loc3_.getSelectedColorIds(),true);
         }
      }
      
      public function selectColor(param1:String, param2:int, param3:int) : void
      {
         var _loc4_:CategoryData = this.var_116[param1];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_28 && this.var_28.figureData)
         {
            this.var_28.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
         }
      }
