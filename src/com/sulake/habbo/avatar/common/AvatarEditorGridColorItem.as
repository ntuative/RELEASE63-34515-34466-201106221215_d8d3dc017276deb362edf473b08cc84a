package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1032:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_943.width,this.var_943.height,true,0);
            _loc5_ = this.var_943.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1032.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_941.width,this.var_941.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_941,this.var_941.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
