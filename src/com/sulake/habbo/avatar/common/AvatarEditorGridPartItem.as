package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_451:IAvatarRenderManager;
      
      private var var_1145:Boolean;
      
      private var var_1800:BitmapData;
      
      private const const_2339:int = 13421772;
      
      private const const_2338:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_741 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1799 = Math.max(this.var_1799,_loc6_.colorLayerIndex);
            }
         }
         this.var_451 = this.var_77.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_741 != null && !this.var_1798)
            {
               _loc3_ = this.var_741;
            }
            else
            ...
            if(this.var_778)
            {
               switch(this.var_778.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_36:
                     _loc2_.style = HabboIconType.const_984;
                     break;
         ...
         if(this.isSelected)
         {
            this.var_1473.color = this.const_2339;
         }
         else
         {
            this.var_1473.color = this.const_2338;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_451.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_451.isFigureReady(_loc1_))
         {
            this.var_451.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               ...
               _loc4_ = this.var_451.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_624 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1800)
               {
                  ...
                  this.var_1800 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1798 && _loc2_.colorLayerIndex > 0)
               {
