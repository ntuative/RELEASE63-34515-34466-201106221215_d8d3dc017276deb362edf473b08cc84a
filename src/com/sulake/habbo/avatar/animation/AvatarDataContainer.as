package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1908:uint;
      
      private var _b:uint;
      
      private var var_1911:Number = 1.0;
      
      private var var_1910:Number = 1.0;
      
      private var var_1909:Number = 1.0;
      ...
      {
         super();
         this.var_1820 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2442 = parseInt(_loc2_,16);
         this.var_2441 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1907 = this._rgb >> 16 & 255;
         this.var_1908 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1911 = this.var_1907 / 255 * 1;
         this.var_1910 = this.var_1908 / 255 * 1;
         this.var_1909 = this._b / 255 * 1;
         if(this.var_1820 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2443 = false;
         }
         this.var_773 = new ColorTransform(this.var_1911,this.var_1910,this.var_1909,this._alphaMultiplier);
         this.var_1215 = this.generatePaletteMapForGrayscale(this.var_2441,this.var_2442);
      }
      ...
      {
         return this.var_1215.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1215.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1215.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1215.getValue("alphas") as Array;
      }
