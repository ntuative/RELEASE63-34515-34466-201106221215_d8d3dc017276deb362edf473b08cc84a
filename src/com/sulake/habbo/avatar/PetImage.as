package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_304:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_58)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1563);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_310.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_310.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_682);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1563 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_109)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_682);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_682);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_682);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_574 = this.var_574 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_394:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1868:
                  case AvatarAction.const_1828:
                  case AvatarAction.const_1173:
                  case AvatarAction.const_1301:
                  case AvatarAction.const_1785:
                  case AvatarAction.const_2024:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_358.push(new ActiveActionData(param1,param2));
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1562 = this._structure.sortActions(this.var_358);
         ...
         {
            this.var_760 = this._structure.getCanvasOffsets(this.var_1562,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1562)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_440)
               {
                  this.var_1018 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_278)
               {
                  this.var_1018 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1345 = _loc4_.id;
                     this.var_1797 = _loc4_.breed;
                     break;
                  }
               }
            }
