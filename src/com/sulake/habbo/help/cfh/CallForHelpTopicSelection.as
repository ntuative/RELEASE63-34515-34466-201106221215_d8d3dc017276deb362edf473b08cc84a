   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_772.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_772.length)
         {
            _loc8_ = this.var_772[_loc6_];
            ...
            _loc11_ = method_2(_loc10_ != null ? _loc10_ : _loc9_,"help_cfh_pick_topic_item",this.onListItemClick);
            if(_loc11_ != null)
            {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_772 == null || _loc3_ < 0 || _loc3_ >= this.var_772.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_772[_loc3_];
            main.showUI(HabboHelpViewEnum.const_819);
            main.tellUI(HabboHelpViewEnum.const_819,null);
         }
      }
   }
}
