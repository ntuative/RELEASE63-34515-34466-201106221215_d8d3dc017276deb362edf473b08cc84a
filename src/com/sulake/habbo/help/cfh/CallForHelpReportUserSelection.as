package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_899 = main.component.userRegistry.getRegistry();
         ...
         {
            user = this.var_899.getWithIndex(i);
            ...
            item = method_2(title,"report_user_pick_user_item",this.onListItemClick);
            if(item != null)
            {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_899.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_899.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
