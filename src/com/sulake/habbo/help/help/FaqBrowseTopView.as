   ...
   public class FaqBrowseTopView extends HelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            _loc7_ = method_2(_loc6_,"help_itemlist_item",this.onListItemClick) as IWindow;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_383);
         main.tellUI(HabboHelpViewEnum.const_383,_loc5_);
      }
   }
}
