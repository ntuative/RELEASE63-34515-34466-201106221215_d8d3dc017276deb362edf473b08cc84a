package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2019:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106221211));
         this.var_130 = new Map();
         this.var_130.add(HabboHelpViewEnum.const_1919,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_205,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_593,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_383,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_274,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_428,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_819,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_282,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_130.add(HabboHelpViewEnum.const_1258,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_130.add(HabboHelpViewEnum.const_1201,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_901,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2019)
         {
            this.var_572 = new Array();
         }
         else if(param2)
         {
            if(this.var_572.length == 0 || param1 != this.var_404)
            {
               this.var_572.push(this.var_404);
            }
         }
         this.var_404 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_404);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_282:
               this.showUI(HabboHelpViewEnum.const_282);
               break;
            case CallForHelpResultEnum.const_1385:
               this.showUI(HabboHelpViewEnum.const_1201);
               break;
            case CallForHelpResultEnum.const_1268:
               this.showUI(HabboHelpViewEnum.const_1258);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_130.getValue(HabboHelpViewEnum.const_205) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_506));
      }
      ...
      {
         return this.var_130.getValue(this.var_404);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2756 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2758;
         this._window.width = _loc1_.width + this.var_2756;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_572.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_404 == HabboHelpViewEnum.const_205)
         {
            return;
         }
         if(this.var_674.length < 2)
         {
            ...
            this.var_674.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_674.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_405.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_674[1],this.var_674[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_674[0],this.var_674[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_404 == HabboHelpViewEnum.const_205 || this.var_572.length == 0)
         {
            return;
         }
         if(this.var_405 == null)
         {
            ...
            this.var_405 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_405.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_405.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_405 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_405 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_405 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
