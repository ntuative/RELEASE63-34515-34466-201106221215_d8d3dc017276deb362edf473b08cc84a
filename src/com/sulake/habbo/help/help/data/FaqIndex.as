package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_807:FaqCategory;
      
      private var var_808:FaqCategory;
      ...
      {
         super();
         this.var_807 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_808 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_806 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_170 != null)
         {
            ...
            {
               _loc2_ = this.var_170.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_170.getValue(param1);
         if(_loc4_ != null || !param3)
         {
            return _loc4_;
         }
         _loc4_ = new FaqCategory(param1,param2);
         this.var_170.add(param1,_loc4_);
         return _loc4_;
      }
      ...
      {
         var _loc4_:* = null;
         if(this.var_807.hasItem(param1))
         {
            this.var_807.getItem(param1).answerText = param2;
         }
         if(this.var_808.hasItem(param1))
         {
            this.var_808.getItem(param1).answerText = param2;
         }
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_170.length)
         {
            _loc4_ = this.var_170.getWithIndex(_loc3_);
      ...
      {
         if(param1 >= this.var_170.length)
         {
            return null;
         }
         return this.var_170.getWithIndex(param1);
      }
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < this.var_170.length)
         {
            _loc2_ = this.var_170.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_807.hasItem(param1))
         {
            return this.var_807.getItem(param1);
         }
         if(this.var_808.hasItem(param1))
         {
            return this.var_808.getItem(param1);
         }
         if(this.var_806.hasItem(param1))
         {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_170.length)
         {
            _loc3_ = this.var_170.getWithIndex(_loc2_);
