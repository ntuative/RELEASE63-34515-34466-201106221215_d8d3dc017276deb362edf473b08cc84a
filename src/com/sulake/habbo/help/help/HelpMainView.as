package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1608:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1608)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc8_ < _loc10_.length)
               {
                  ...
                  _loc9_ = method_2(_loc11_,"help_itemlist_item_urgent",this.onListItemClick);
                  if(_loc9_ != null)
                  {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc11_ = _loc10_[_loc8_];
                  _loc9_ = method_2(_loc11_,"help_itemlist_item_white_bg",this.onListItemClick);
                  if(_loc9_ != null)
                  {
