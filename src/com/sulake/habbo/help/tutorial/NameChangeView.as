package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_2060:uint = 11129827;
       
      
      private var var_28:INameChangeUI;
      ...
      private var var_1342:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            this._window = this.var_28.buildXmlWindow("welcome_name_change") as IFrameWindow;
            this._window.center();
            this._window.procedure = this.windowEventHandler;
            this.var_2058 = this._window.content.getChildAt(0) as IWindowContainer;
         }
         this.var_28.localization.registerParameter("tutorial.name_change.current","name",this.var_28.myName);
         this._window.caption = this.var_28.localization.getKey("tutorial.name_change.title.main");
         this.showView(this.var_2058);
      }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_870)
         {
            this.var_870 = this.var_28.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_870)
            {
               return;
            }
            this._window.content.addChild(this.var_870);
         }
         this._window.caption = this.var_28.localization.getKey("tutorial.name_change.title.select");
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_871)
         {
            this.var_871 = this.var_28.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_871)
            {
               return;
            }
            this._window.content.addChild(this.var_871);
         }
         this._window.caption = this.var_28.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_871.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_578;
         }
         this.showView(this.var_871);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_28.localization.registerParameter("help.tutorial.name.available","name",this.var_578);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_917:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_916:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_920:
               break;
            case ChangeUserNameResultMessageEvent.var_919:
               _loc4_.text = this.var_28.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_918:
               _loc4_.text = this.var_28.localization.getKey("help.tutorial.name.short");
               break;
            case ChangeUserNameResultMessageEvent.var_1133:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1134 || param1 == ChangeUserNameResultMessageEvent.var_1133)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1342 = new NameSuggestionListRenderer(this.var_28);
         var _loc6_:int = this.var_1342.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_578 = this.var_28.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_578 != _loc5_)
               {
                  this.var_2059 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_28.changeName(this.var_578);
               break;
            ...
            case "header_button_close":
               this.var_28.showView(TutorialUI.const_95);
         }
      }
