package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_870)
         {
            this.var_870 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_870)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_871)
         {
            this.var_871 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_871)
            {
               return;
            }
