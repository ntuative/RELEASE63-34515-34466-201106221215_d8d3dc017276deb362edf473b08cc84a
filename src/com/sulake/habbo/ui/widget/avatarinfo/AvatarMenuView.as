package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1030:uint = 1;
      
      protected static const const_1031:uint = 2;
      
      protected static var var_1423:uint = const_1030;
      
      private static const const_1426:uint = 16744755;
      
      private static const const_1425:uint = 16756591;
      
      private static const const_1041:int = 8;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_729:uint = 1;
      
      protected var var_1692:Boolean;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1692)
         {
            ...
            {
               this.var_729 = const_1031;
            }
            else
            {
               this.var_729 = var_1423;
            }
         }
         if(this.var_729 == const_1030)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1041;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1041;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2047) : uint(const_1411);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1425;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1426;
               }
            }
         }
         if(_loc3_)
