package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_463:IFrameWindow;
      ...
      private const const_2347:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_390 = new Timer(this.const_2347);
         this.var_390.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc4_:ITextWindow = this.var_44.findChildByName("pet_name") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.text = param2;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_44.findChildByName("avatar_image") as IBitmapWrapperWindow;
         if(_loc5_ != null)
         {
            if(param3 != null)
            {
         ...
         var _loc6_:CommandConfiguration = this.var_1261.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_550);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1261.getValue(this.var_550) as CommandConfiguration;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_898,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_44 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_44 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_44.setParamFlag(WindowParam.const_106,true);
         this.var_44.context.getDesktopWindow().addEventListener(WindowEvent.const_40,this.onWindowDesktopResized);
         this.var_44.procedure = this.onCommandWindowProcedure;
         this.var_44.position = const_1458;
      }
      ...
      private function updateCommandButtonsViewState(param1:CommandConfiguration) : void
      {
         ...
         var _loc2_:IWindowContainer = IWindowContainer(this.var_44.findChildByName("commands_container"));
         hideChildren(_loc2_);
         ...
         while(_loc8_ < _loc3_.length)
         {
            ...
            if(_loc9_ == null)
            {
               ...
               _loc9_.procedure = this.method_6;
         ...
         this.var_44.height = _loc2_.height + 160;
         this.var_390.stop();
      }
      ...
      private function disableAllButtons() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_44.findChildByName("commands_container"));
         var _loc2_:int = 0;
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_463 == null)
         {
            ...
            this.var_463 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_463 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_463.x = 200;
            this.var_463.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_285,this.var_550));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_645,this.var_550,this.var_1926 + " " + _loc6_);
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_645,this.var_550,this.var_1926 + " " + _loc5_);
      ...
      private function onWindowDesktopResized(param1:WindowEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_44 && !this.var_44.disposed)
         {
            _loc2_ = param1.window;
            _loc3_ = new Rectangle();
            this.var_44.getGlobalRectangle(_loc3_);
            if(_loc3_.x > _loc2_.width)
            {
               this.var_44.x = _loc2_.width - this.var_44.width;
               this.var_44.getGlobalRectangle(_loc3_);
            }
