package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1507:int = 152;
      
      private static const const_1505:int = 16;
      
      private static const const_689:int = 4;
      
      private static const const_1506:uint = 14342874;
      
      private static const const_1498:uint = 3815994;
      
      private static const const_1499:uint = 2085362;
      
      private static const const_1511:uint = 39616;
      
      private static const const_1508:uint = 10513106;
      
      private static const const_1500:uint = 8734654;
      
      private static const const_1503:uint = 9094430;
      
      private static const const_1509:uint = 6200576;
      
      private static const const_1504:String = "happiness";
      
      private static const const_1501:String = "experience";
      
      private static const const_1502:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1504,param1.nutrition,param1.nutritionMax,const_1511,const_1499);
         this.updateStateElement(const_1501,param1.experience,param1.experienceMax,const_1500,const_1508);
         this.updateStateElement(const_1502,param1.energy,param1.energyMax,const_1509,const_1503);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1507,const_1505,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1506);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1498);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_689,_loc7_.width - 2,_loc7_.height - 2 - const_689);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_689);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_550) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_215 && this.var_215.getPetId() == this.var_550)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_2020,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_453,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1061 + const_1062;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1062;
            }
         }
         this.var_107.height = _loc4_ + const_1061;
         this.updateWindow();
      }
   }
}
