package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2336:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_175:Function;
      
      private var _offsetX:int;
      
      private var var_1198:int;
      
      private var var_1199:Rectangle = null;
      
      private var var_3054:int = 0;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1198 = 0;
         this.var_1199 = param2.rectangle.clone();
         this.var_1199.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1199.width)
         {
            return false;
         }
         if(this.var_1198 + param1.height > this.var_1199.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1199.width)
         {
            this._offsetX = 0;
            this.var_1198 += param1.height + this.const_2336;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1198);
         this._offsetX += param1.width + this.const_2335;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1472 != null && this.var_1472.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_175);
