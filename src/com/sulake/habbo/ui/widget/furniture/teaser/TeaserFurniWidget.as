package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2057:int = 0;
      
      private const const_2051:int = 1;
      
      private const const_2054:int = 2;
      
      private const const_2053:int = 3;
      
      private const const_2052:int = 4;
      
      private const const_2327:int = 0;
      
      private const const_2329:int = 1;
      
      private const const_2326:int = 2;
      
      private const const_2322:int = 3;
      
      private const const_2328:int = 4;
      
      private const const_2324:int = 5;
      
      private const const_2055:String = "deco_img";
      
      private const const_2056:String = "dialog_bg";
      
      private const const_2323:String = "%campaign%_dialog_bg.png";
      
      private const const_386:String = "%campaign%_gift_package.png";
      
      private const const_2321:String = "%campaign%_gift_content.png";
      
      private const const_2325:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1448 = this.var_152.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1448 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1449.length)
         {
            _loc2_ = this.var_1449.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_152 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_997,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_969:
               ...
               {
                  _loc2_ = this.const_2052;
               }
               this._shareId = null;
               this.var_1450 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_997:
               _loc2_ = this.const_2051;
               this.var_235 = param1.objectId;
               this._shareId = param1.data;
               this.var_427 = param1.status;
               this.var_1450 = param1.itemCategory;
         ...
         if(this._window && (this.var_1451 != _loc2_ || _loc3_ != this.var_192))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1451)
            {
               case this.const_2057:
                  ...
                  break;
               case this.const_2051:
                  if(this.var_427 == this.const_2327)
                  {
                  ...
                  else if(this.var_427 == this.const_2329)
                  {
                     ...
                     _loc2_ = this.const_2321;
                  }
                  else if(this.var_427 == this.const_2326)
                  {
                  ...
                  else if(this.var_427 == this.const_2322)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_427 == this.const_2328)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_192,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_427 == this.const_2324)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2323.replace("%campaign%",this.var_192);
            this.setDecoImage(_loc5_,this.const_2056);
            _loc2_ = _loc2_.replace("%campaign%",this.var_192);
            this.setDecoImage(_loc2_,this.const_2055);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_868);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_152.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1450 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1450 == 1 ? "null" : InventoryCategory.const_133);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_983,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1449.push(new ImageDownloader(this,_assets,this.var_192,this.var_1448,param1,param2));
            return;
         }
