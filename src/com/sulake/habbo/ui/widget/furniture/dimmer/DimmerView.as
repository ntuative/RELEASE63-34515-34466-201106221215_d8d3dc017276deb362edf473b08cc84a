package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1647:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_709:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_70,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1513,const_1512,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_709 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1646 = _loc2_.light;
         if(this.var_493 != null)
         {
            this.var_493.setValue(this.var_1646);
         }
         this.var_527 = this.colors.indexOf(_loc2_.color);
         if(this.var_709 != null)
         {
            this.var_709.setSelectedColorIndex(this.var_527);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1647 = XML(_loc1_.content);
         return this.var_1647;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_709 != null)
         {
            this.var_709.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
