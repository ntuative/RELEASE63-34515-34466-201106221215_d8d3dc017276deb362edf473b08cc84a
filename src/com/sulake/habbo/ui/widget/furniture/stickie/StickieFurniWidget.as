package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1543:int = 14;
      
      private static const const_1542:int = 500;
      
      private static const const_1513:Number = 100;
      
      private static const const_1512:Number = 100;
      ...
      protected var var_356:String;
      
      protected var var_28:Boolean;
      
      protected var var_2240:String = "stickieui_container";
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1411 = param1.objectType;
         this._text = param1.text;
         this.var_356 = param1.colorHex;
         this.var_28 = param1.controller;
         this.showInterface();
      }
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2240,"",HabboWindowType.const_70,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1513,const_1512,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_111,this.onTextWindowEvent);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1411 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_356);
            }
         ...
         this.setColorButtons(this.var_28 && this.var_1411 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_522,this.var_235,this._text,this.var_356);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_522,this.var_235,this._text,this.var_356);
      ...
      protected function sendDelete() : void
      {
         ...
         if(messageListener != null && this.var_28)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_771,this.var_235);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1542;
         if(_loc2_.numLines < const_1543)
         {
            return;
         }
