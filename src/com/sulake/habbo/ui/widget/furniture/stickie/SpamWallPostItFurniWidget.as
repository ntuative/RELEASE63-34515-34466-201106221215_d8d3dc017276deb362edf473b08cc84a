package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2240 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_626,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_626,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_437 = param1.location;
         var_1411 = param1.objectType;
         _text = "";
         var_356 = "FFFF33";
         var_28 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_235 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_816,var_235,this.var_437,_text,var_356);
