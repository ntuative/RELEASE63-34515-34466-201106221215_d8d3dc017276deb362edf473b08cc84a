package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1832:MeMenuSoundSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1832.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_791 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_791.width,this.var_791.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_791,this.var_791.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_792 != null)
               {
                  ...
                  this.var_1831 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
