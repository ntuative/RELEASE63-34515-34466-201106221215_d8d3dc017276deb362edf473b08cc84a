package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_693:IItemGridWindow;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_693.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_1331;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_113 != null)
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_529;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_171;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_113.playButtonState == MusicInventoryGridItem.const_529)
               {
                  this.var_113.playButtonState = MusicInventoryGridItem.const_1184;
            ...
            {
               _loc4_ = this.var_693.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
