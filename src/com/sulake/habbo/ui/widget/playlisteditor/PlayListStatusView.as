package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_814:String = "PLSV_ADD_SONGS";
      
      public static const const_1352:String = "PLSV_START_PLAYBACK";
      
      public static const const_504:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_52 != const_504)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_471[this.var_52];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_471[const_814];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_471.add(const_504,_loc1_);
