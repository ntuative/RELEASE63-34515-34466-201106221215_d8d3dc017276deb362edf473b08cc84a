package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1798:String = "POLL_OFFER_STATE_OK";
      
      public static const const_829:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_114:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_114)
         {
            return;
         }
         this._state = const_1798;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_1021,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_829;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_622,this._id));
