package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_602);
         _loc1_.push(InterstitialEvent.const_585);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_115);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_340);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_602:
               ...
               break;
            case InterstitialEvent.const_585:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_115:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_340:
               this._container.events.dispatchEvent(param1);
         }
      }
