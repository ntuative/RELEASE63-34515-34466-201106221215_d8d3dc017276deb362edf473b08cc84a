package com.sulake.habbo.ui.handler
{
   ...
   public class PetPackageFurniWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IPetDataListener, IGetImageListener
   {
      ...
      {
         return [RoomSessionPetPackageEvent.const_650,RoomSessionPetPackageEvent.const_641];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPetPackageEvent.const_650:
                  _loc2_ = param1 as RoomSessionPetPackageEvent;
                  this.var_235 = _loc2_.objectId;
                  this.var_1345 = _loc2_.petType;
                  this.var_1797 = _loc2_.breed;
                  this._color = _loc2_.color;
                  _loc4_ = this._container.avatarRenderManager.petDataManager.getPetData(this.var_1345,this);
                  _loc5_ = this.getPetImage();
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_578,this.var_235,_loc5_,-1,null);
                  this._container.events.dispatchEvent(_loc3_);
                  break;
               case RoomSessionPetPackageEvent.const_641:
                  _loc2_ = param1 as RoomSessionPetPackageEvent;
                  this.var_235 = _loc2_.objectId;
                  _loc6_ = _loc2_.nameValidationStatus;
                  _loc7_ = _loc2_.nameValidationInfo;
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_594,this.var_235,null,_loc6_,_loc7_);
                  this._container.events.dispatchEvent(_loc3_);
            }
         }
      }
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_398,this.var_235,_loc2_,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_398,this.var_235,param2,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      ...
      private function getPetImage() : BitmapData
      {
         ...
         if(this.var_1345 < 8)
         {
            ...
            _loc2_ = this._container.avatarRenderManager.createPetImage(this.var_1345,this.var_1797,_loc1_,AvatarScaleType.const_61,this);
            if(_loc2_ != null)
            {
         ...
         {
            _loc3_ = 0;
            _loc4_ = this._container.roomEngine.getPetImage(this.var_1345,this.var_1797,new Vector3d(90),64,this,_loc3_);
            if(_loc4_ != null)
            {
               return _loc4_.data;
            }
