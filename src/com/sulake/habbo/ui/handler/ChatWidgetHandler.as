package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_716:Map = null;
      
      private var var_2121:Map = null;
      ...
      private var var_895:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_344 != null)
         {
            ...
            {
               _loc2_ = this.var_344.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_959,RoomWidgetChatSelectAvatarMessage.const_1016];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_959:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_36) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1245))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_406);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_36) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1245))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_671);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_1016:
      ...
      {
         return [RoomSessionChatEvent.const_221];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_221:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_210)
                           {
                              _loc13_ = this.var_344.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_496.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_716.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_210:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_716.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_109,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_716.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_210)
                                    {
                                       this.var_344.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1373 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1373);
            }
            if(this.var_895 == null)
            {
               ...
               this.var_591.y = 0;
               this.var_591.z = 0;
               this.var_895 = _loc4_.getScreenPoint(this.var_591);
               this.var_1373 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_591.x = 0;
            this.var_591.y = 0;
            this.var_591.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_591);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_895.x || _loc8_.y != this.var_895.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_895,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_344)
         {
            _loc2_ = this.var_344.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_109,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_716.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2121.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2121.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_344)
            {
               this.var_344.add(_loc3_,param2);
            }
         }
      }
   }
