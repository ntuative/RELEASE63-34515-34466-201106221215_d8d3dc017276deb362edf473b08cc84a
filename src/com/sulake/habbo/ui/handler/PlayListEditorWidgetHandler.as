package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1612:IMessageEvent;
      
      private var var_2045:IMessageEvent;
      
      private var var_2046:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_145,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_105,this.processSoundManagerEvent);
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_121,this.processSoundManagerEvent);
      ...
      {
         this.var_1612 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2045 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2046 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1612);
         this._connection.addMessageEvent(this.var_2045);
         this._connection.addMessageEvent(this.var_2046);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1612);
               this._connection.removeMessageEvent(this.var_2045);
               this._connection.removeMessageEvent(this.var_2046);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_145,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_105,this.processSoundManagerEvent);
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_121,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_874,RoomWidgetPlayListModificationMessage.const_774,RoomWidgetPlayListModificationMessage.const_735,RoomWidgetPlayListPlayStateMessage.const_1018,RoomWidgetPlayListUserActionMessage.const_958];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_874:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_978,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_774:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_735:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_1018:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_958:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_287:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_894,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1014,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_813));
               break;
            case PlayListStatusEvent.const_102:
               ...
               break;
            case PlayListStatusEvent.const_145:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_145));
               break;
            case NowPlayingEvent.const_105:
               ...
               break;
            case NowPlayingEvent.const_121:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_121,_loc2_.id,_loc2_.position,_loc2_.priority));
               break;
