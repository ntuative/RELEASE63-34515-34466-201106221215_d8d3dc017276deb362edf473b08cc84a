   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container)
         {
            ...
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_951,this.onUserNameUpdate);
         }
         this._container = param1;
         if(this._container)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_951,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_1009);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_1009:
               this.dispatchOwnAvatarInfo();
               break;
