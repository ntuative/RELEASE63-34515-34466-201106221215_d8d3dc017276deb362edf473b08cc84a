package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_935,RoomWidgetViralFurniMessage.const_868,RoomWidgetViralFurniMessage.const_187];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_935:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_868:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_567,RoomSessionViralFurniStatusEvent.const_515];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_567:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_997);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_515:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
