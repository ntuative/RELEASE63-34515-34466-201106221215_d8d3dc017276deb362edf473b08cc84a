package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_254.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_179,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_203,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_186,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_179,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_203,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_186,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_722.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_722.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_254 != null)
         {
            this.var_254.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_576);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_973);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_453);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_923);
         _loc1_.push(RoomWidgetFurniActionMessage.const_312);
         _loc1_.push(RoomWidgetFurniActionMessage.const_854);
         _loc1_.push(RoomWidgetFurniActionMessage.const_736);
         _loc1_.push(RoomWidgetFurniActionMessage.const_769);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1354);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_824);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_772);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_956);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_898);
         _loc1_.push(RoomWidgetUserActionMessage.const_637);
         _loc1_.push(RoomWidgetUserActionMessage.const_285);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_963);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_643)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_285 || param1.type == RoomWidgetUserActionMessage.const_637 || param1.type == RoomWidgetUserActionMessage.const_658)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_576:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_973:
            ...
            case RoomWidgetUserActionMessage.const_554:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1381,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_664:
               ...
               break;
            case RoomWidgetUserActionMessage.const_453:
            ...
            case RoomWidgetUserActionMessage.const_528:
               ...
               break;
            case RoomWidgetUserActionMessage.const_923:
            ...
            case RoomWidgetUserActionMessage.const_658:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_854:
            ...
            case RoomWidgetFurniActionMessage.const_1354:
               ...
               break;
            case RoomWidgetUserActionMessage.const_285:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_824:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_772:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_956:
            ...
            case RoomWidgetUserActionMessage.const_516:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_898:
            ...
            case RoomWidgetPetCommandMessage.const_645:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_963:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_298);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_424) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_424);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_809) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1226;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_298);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1198);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_668)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_429) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_429.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_210)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_537)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_375);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_113)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_147)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_882);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_756;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_989;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1916);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_174];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_174:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_722.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_722.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_882);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_254 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_395,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_254 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_430,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
