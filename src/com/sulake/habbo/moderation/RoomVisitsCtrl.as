package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2107:int = 200;
      ...
      {
         this.var_890 = IWindowContainer(this.var_37.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1773;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_890.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1104.length < var_2107)
         {
            ...
            param1.width = this.var_890.width;
            param1.height = this.var_890.height;
