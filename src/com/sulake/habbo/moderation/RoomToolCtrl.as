package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1553:ICheckBoxWindow;
      
      private var var_1554:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_37.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_375));
         Logger.log("BEGINNING TO SHOW: " + this.var_375);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1971;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_375);
         if(param1.flatId != this.var_375)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_375);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1043 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1553 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1554 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_37,WindowTracker.const_996,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1043.isSelected);
         this.var_37.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1967,_loc2_,this.var_535.text,"",""));
         if(this.var_1553.isSelected || this.var_1554.isSelected || this.var_1043.isSelected)
         {
            this.var_37.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1553.isSelected,this.var_1554.isSelected,this.var_1043.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1815);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_37.initMsg.roomMessageTemplates[this.var_1177.selection];
         if(_loc3_ != null)
         {
            this.var_717 = false;
