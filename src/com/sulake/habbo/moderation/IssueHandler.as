package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1224:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_538 = new UserInfoCtrl(this._window,this.var_71,_loc3_.message);
         this.var_1224 = new UserInfoCtrl(this._window,this.var_71,_loc3_.message);
         ...
         {
            this.var_1224.load(_loc4_,this.var_169.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_71 != null && this.var_71.issueManager != null && this.var_169 != null)
         {
            this.var_71.issueManager.removeHandler(this.var_169.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_71.issueManager.closeBundle(this.var_169.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_71.issueManager.closeBundle(this.var_169.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_71.issueManager.closeBundle(this.var_169.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_71.issueManager.releaseBundle(this.var_169.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_71.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_71,WindowTracker.const_1292,_loc2_),this._window,false,false,true);
      }
