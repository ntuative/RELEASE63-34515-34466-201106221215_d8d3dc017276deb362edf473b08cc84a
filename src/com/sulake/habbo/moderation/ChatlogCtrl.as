package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1009:Array = [];
      
      private static var var_1898:int = 1000;
      
      private static var var_1008:Array = [];
      
      private static var var_1897:int = 200;
      ...
      private var var_1900:IMessageComposer;
      ...
      {
         this.var_811 = IWindowContainer(this.var_37.getXmlWindow("chatlog_roomheader"));
         this.var_810 = IWindowContainer(this.var_37.getXmlWindow("chatlog_chatline"));
         this.var_534 = new Timer(1000,1);
         ...
         this.var_37.connection.send(this.var_1900);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1009.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_810.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1009.length < var_1898)
         {
            ...
            param1.width = this.var_810.width;
            param1.height = this.var_810.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1514.getValue(param2.chatterName))
            {
               this.var_1514.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1514.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1513)
         {
