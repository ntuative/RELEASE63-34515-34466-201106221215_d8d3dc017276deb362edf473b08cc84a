package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2343:String = "my_issues";
      
      private const const_2342:String = "open_issues";
      
      private const const_2344:String = "picked_issues";
      
      private const const_2362:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_380.view.width = this.var_274.container.width;
         this.var_380.view.height = this.var_274.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2343:
               if(this.var_1857 == null)
               {
                  this.var_1857 = new MyIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1857;
            case this.const_2342:
               if(this.var_1856 == null)
               {
                  this.var_1856 = new OpenIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1856;
            case this.const_2344:
               if(this.var_1858 == null)
               {
                  this.var_1858 = new PickedIssuesView(this.issueManager,this,this.var_274.container);
               }
