package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_774:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2397 = param2.pickerUserId;
         this.var_2398 = param2.pickerUserName;
         this.var_1590 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1194 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1195;
         }
         if(this.var_774 == null || param1.timeStamp < this.var_774.timeStamp)
         {
            this.var_774 = param1;
         }
         if(this.var_775 == null || param1.priority > this.var_775.timeStamp)
         {
            this.var_775 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1194 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1195;
            }
            if(this.var_774 == _loc2_)
            {
               this.var_774 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_775;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_774;
         if(_loc2_ == null)
         {
