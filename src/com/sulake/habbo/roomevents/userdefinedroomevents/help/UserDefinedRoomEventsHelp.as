package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2021 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1317 = this.var_2021.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1317)
         {
            this.var_1317.procedure = this.onButtonClick;
         }
         this.var_1318 = this.var_2021.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1318)
         {
            this.var_1318.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_288 >= this.var_76.length - 1)
         {
            this.var_1318.disable();
         }
         else
         {
            this.var_1318.enable();
         }
         if(this.var_288 <= 0)
         {
            this.var_1317.disable();
         }
         else
         {
            this.var_1317.enable();
         }
      }
      ...
      {
         ++this.var_288;
         this.var_288 = Math.min(this.var_288,this.var_76.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_76[this.var_288][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_76[this.var_288][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_76[this.var_288][1]).value;
