package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_791:BitmapData;
      ...
      private var var_1388:Number = 1.0;
      
      private var var_732:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1388,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1126);
         }
      ...
      {
         return int(this.var_1831 * (Number(param1 - this._minValue) / (this.var_1388 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1831 * (this.var_1388 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1127)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_248)
            {
               this.var_1127 = false;
            }
         }
         if(!this.var_1127 || param1.type != WindowEvent.const_438)
         {
            return;
         }
         if(this.var_732 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_732) * this.var_732;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_732 != 0)
            {
               _loc3_ = this.var_1126 + this.var_732;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_791 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_791.width,this.var_791.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_791,this.var_791.rect,new Point(0,0),null,null,true);
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_791 = BitmapData(_loc2_.content);
