package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_353:int = 3;
      
      private static var var_1683:int = 2;
      ...
      private var var_2169:TriggerConfs;
      
      private var var_2168:ActionTypes;
      
      private var var_2167:ConditionTypes;
      
      private var var_305:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_910:RoomObjectHightLighter;
      ...
      {
         this.var_2169 = new TriggerConfs();
         this.var_2168 = new ActionTypes();
         this.var_2167 = new ConditionTypes();
         this.var_305 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_910 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_305[param1])
         {
            delete this.var_305[param1];
            this.var_910.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_305[param1] = param2;
            this.var_910.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1389 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1389.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1389.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_910.hideAll(this.var_305);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_353)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_94.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_38.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_38 as TriggerDefinition != null)
         {
            this.var_94.send(new UpdateTriggerMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ActionDefinition != null)
         {
            this.var_94.send(new UpdateActionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ConditionDefinition != null)
         {
            this.var_94.send(new UpdateConditionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1389.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1683) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1683 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_94.send(new ApplySnapshotMessageComposer(this.var_38.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_353)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2169);
         this.refreshConfigureElement(this.var_2168);
         this.refreshConfigureElement(this.var_2167);
