package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc2_:ICoreLocalizationManager = this.var_28.localization;
         var _loc4_:* = "";
         var _loc5_:int = this.var_28.getClubType();
         ...
         var _loc7_:IPurse = this.var_28.getPurse();
      ...
      {
         if(!param1 || !param2 || !this.var_28 || !this.var_104)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_28.confirmSelection(this.var_104,this.var_1478);
               break;
