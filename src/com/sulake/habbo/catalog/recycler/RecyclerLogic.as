package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_706 != const_1142;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2099 != RecyclerStatusMessageEvent.const_1398;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_706 == const_486;
      }
      ...
      {
         this.var_706 = const_1141;
         this.var_139 = new Array(const_223);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2099)
         {
            case RecyclerStatusMessageEvent.const_1781:
               this.var_706 = const_486;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1398:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1882:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1297:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1734:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_139.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_223)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_139.length < const_223)
         {
            return false;
         }
         var _loc1_:int = 0;
