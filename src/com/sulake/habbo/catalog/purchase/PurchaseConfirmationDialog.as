package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2340:int = 10;
      ...
      private const const_2074:uint = 4.293848814E9;
      
      private const const_2073:uint = 4.294967295E9;
      
      private const const_1716:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1203 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_111,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_46,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_341,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_342,this.onMessageInputFocus);
         }
         this.var_1809 = true;
         this.var_1808 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_355,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_530,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1810 = _loc1_.stuffTypes;
            this.var_782 = _loc1_.boxTypes;
            this.var_781 = _loc1_.ribbonTypes;
            this.var_1202 = this.var_1810[0];
            this.var_372 = this.var_782[0];
            this.var_374 = this.var_781[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_374 < 0)
         {
            this.var_374 = this.var_781.length - 1;
         }
         if(this.var_374 > this.var_781.length - 1)
         {
            this.var_374 = 0;
         }
         if(this.var_372 < 0)
         {
            this.var_372 = this.var_782.length - 1;
         }
         if(this.var_372 > this.var_782.length - 1)
         {
            this.var_372 = 0;
         }
         var _loc1_:int = this.var_782[this.var_372] * 1000 + this.var_781[this.var_374];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1202,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1480 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1810)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1202);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_782[this.var_372]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_781[this.var_374]);
         this._catalog.purchaseProductAsGift(this.var_1478,this.var_1203,this.var_1479,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1478,this.var_1203,this.var_1479);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2435 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_243)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2340)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2435 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_373 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_373 + 1);
               break;
      ...
      {
         if(this.var_273 == null || !this.var_273.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_273.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_373) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_273 == null)
         {
            this.var_273 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_783 == null)
         {
            this.var_783 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_273 == null || this.var_783 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_273.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_783.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_273.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_373) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_373);
         }
         this.var_373 = param1;
         if(this.var_373 < 0)
         {
            this.var_373 = _loc2_.numListItems - 1;
         }
         if(this.var_373 >= _loc2_.numListItems)
         {
            this.var_373 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_373) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1716;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2074) : uint(this.const_2073);
      }
      ...
      {
         this.var_1202 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1202;
               }
            }
            _loc4_++;
         }
