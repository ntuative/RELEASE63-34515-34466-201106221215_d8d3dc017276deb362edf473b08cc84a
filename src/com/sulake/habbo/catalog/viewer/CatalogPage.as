package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2033:String = "ctlg_";
       
      
      protected var var_2245:XML;
      ...
      private var var_554:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_554 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1273);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1273);
      }
      ...
      {
         var _loc2_:String = const_2033 + param1;
         ...
         this.var_2245 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2245) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_2014:
               if(this.var_1274 == null)
               {
                  this.var_1274 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_40.push(this.var_1274);
               }
               break;
            case CatalogWidgetEnum.const_1923:
            ...
            case CatalogWidgetEnum.const_1941:
               ...
               break;
            case CatalogWidgetEnum.const_1944:
            ...
            case CatalogWidgetEnum.const_1859:
               ...
               break;
            case CatalogWidgetEnum.const_1876:
            ...
            case CatalogWidgetEnum.const_1791:
               ...
               break;
            case CatalogWidgetEnum.const_1992:
            ...
            case CatalogWidgetEnum.const_1804:
               ...
               break;
            case CatalogWidgetEnum.const_1985:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_554.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_554 != null)
         {
            return this.var_554.dispatchEvent(param1);
         }
         return false;
      }
