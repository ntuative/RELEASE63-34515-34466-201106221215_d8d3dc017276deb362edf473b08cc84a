package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1063:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_219:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_546:Object;
      ...
      {
         this._view.getChildByName(const_1063).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1063).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_89,MouseCursorType.const_899);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_899);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_219.select(this);
            this.var_546 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_546 != null && this.var_546 == param2)
         {
            _loc3_ = this.var_219.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_546 = null;
            }
