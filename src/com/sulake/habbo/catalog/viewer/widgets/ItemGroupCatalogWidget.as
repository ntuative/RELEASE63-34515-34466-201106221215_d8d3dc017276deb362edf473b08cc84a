package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_213[this.var_531][this.var_634];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_531 = var_507.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_531];
         var _loc3_:Array = this.var_213[this.var_531] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_634));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_213[this.var_531] as Array;
         var _loc3_:Offer = _loc2_[this.var_634] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_634 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_634] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var_507.destroyGridItems();
         this.populateItemGrid();
         var _loc1_:Array = this.var_213[this.var_531] as Array;
         var _loc2_:Offer = _loc1_[this.var_634] as Offer;
         var_236 = _loc2_.productContainer as ProductGridItem;
         var_236.activate();
      }
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_454 || _loc1_.pricingModel == Offer.const_405)
            {
