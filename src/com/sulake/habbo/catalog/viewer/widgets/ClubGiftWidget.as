package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(this.var_28.giftsAvailable > 0)
         {
            _loc2_ = "catalog.club_gift.available";
            this.var_28.localization.registerParameter(_loc2_,"amount",this.var_28.giftsAvailable.toString());
         }
         else if(this.var_28.daysUntilNextGift > 0)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            this.var_28.localization.registerParameter(_loc2_,"days",this.var_28.daysUntilNextGift.toString());
         }
         else if(this.var_28.hasClub)
         {
         ...
         _loc1_.text = this.var_28.localization.getKey(_loc2_);
         if(!this.var_28.purse)
         {
            return;
         }
         ...
         if(_loc5_)
         {
            _loc7_ = this.var_28.purse.pastClubDays + this.var_28.purse.pastVipDays;
            ...
            this.var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc5_.text = this.var_28.localization.getKey(_loc2_);
         }
         var _loc6_:ITextWindow = window.findChildByName("past_vip_days") as ITextWindow;
         if(_loc6_)
         {
            _loc2_ = this.var_28.purse.pastVipDays >= this.const_242 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_28.purse.pastVipDays % this.const_242;
            _loc4_ = this.var_28.purse.pastVipDays / this.const_242;
            this.var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc6_.text = this.var_28.localization.getKey(_loc2_);
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this._offers.reset();
         _loc2_ = this.var_28.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = this.var_28.getGiftData();
         if(!_loc3_)
         {
            return;
         }
         ...
         {
            _loc7_ = new Array();
            _loc8_ = this.var_28.catalog.getProductData(_loc6_.localizationId);
            for each(_loc9_ in _loc6_.products)
            {
               _loc11_ = this.var_28.catalog.getFurnitureData(_loc9_.furniClassId,_loc9_.productType);
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(param2.isVip)
         {
            _loc6_ = param2.daysRequired - this.var_28.purse.pastVipDays;
         }
         else
         {
            _loc6_ = param2.daysRequired - (this.var_28.purse.pastClubDays + this.var_28.purse.pastVipDays);
         }
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            this.var_28.localization.registerParameter(_loc7_,"days",_loc12_.toString());
            this.var_28.localization.registerParameter(_loc7_,"months",_loc13_.toString());
         }
         else if(this.var_28.giftsAvailable > 0)
         {
         ...
         this.setText(_loc3_.findChildByName("months_required"),_loc7_.length > 0 ? this.var_28.localization.getKey(_loc7_) : "");
         ...
         if(_loc9_)
         {
            if(param2.isSelectable && this.var_28.giftsAvailable > 0)
            {
               _loc9_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            ...
            _loc11_.procedure = this.method_7;
      ...
      {
         if(!param1 || !param2 || !this._offers || !this.var_28)
         {
            return;
         }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_261)
         {
            this.var_261 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_261)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_261.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_261.setGlobalPosition(_loc6_.subtract(new Point(this.var_261.width / 2,this.var_261.height / 2)));
         this.var_261.visible = true;
         this.var_261.activate();
      }
