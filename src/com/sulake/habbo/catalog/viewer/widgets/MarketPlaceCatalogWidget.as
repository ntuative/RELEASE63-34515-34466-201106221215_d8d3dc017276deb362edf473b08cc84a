package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2351:int = 40;
      
      private const const_2350:int = 10;
      
      private var var_824:Array;
      
      private var var_1542:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_657)
         {
            ...
            this.var_657 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_657)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2072,_loc3_.length,_loc2_);
         if(!this.var_557)
         {
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_657 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_657.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2071);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_111)
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1542.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_48)
