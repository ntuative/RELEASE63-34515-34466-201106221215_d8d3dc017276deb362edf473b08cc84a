package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_116[this.var_531]);
      ...
      {
         var _loc2_:int = this.var_634[this.var_531];
         var _loc3_:Offer = this.var_213[this.var_531][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_507.numGridItems)
         {
            _loc2_ = this.var_213[this.var_531][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_634[this.var_531] = (this.var_213[this.var_531] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_634[0];
         var _loc2_:int = this.var_634[1];
         var _loc3_:int = this.var_634[2];
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_213[this.var_531],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_634[this.var_531];
