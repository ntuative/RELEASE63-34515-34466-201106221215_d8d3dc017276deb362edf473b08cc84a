package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_116:String = "floor";
      ...
      private var var_1452:String = "default";
      ...
      private var var_950:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_950 = this.parseElements(_loc2_.floors.pattern);
         this.var_1170 = this.parseElements(_loc2_.walls.pattern);
         this.var_1171 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_950)
                  {
                     _loc11_ = this.var_950[_loc10_];
                     if(this.var_617.indexOf(_loc10_) == -1)
                     {
                        this.var_617.push(_loc10_);
                        this.var_1169.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1170[_loc8_] != null)
                  {
                     this.var_757.push(_loc8_);
                     this.var_1168.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1171[_loc8_] != null)
                  {
                     this.var_758.push(_loc8_);
         ...
         this.changePattern(const_116,0);
         this.changePattern(const_236,0);
         this.changePattern(TYPE_LANDSCAPE,0);
         this.updateConfiguration();
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1452,this.var_1453,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1168[this.var_445];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1452);
               }
               break;
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_116,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_116,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_116,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_116,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1169[this.var_442];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_444];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_617[this.var_442];
         var _loc3_:Array = this.var_950[_loc2_];
         if(_loc3_ != null && this.var_443 >= 0)
         {
            _loc11_ = _loc3_[this.var_443];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1169[this.var_442];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_757[this.var_445];
         var _loc6_:Array = this.var_1170[_loc5_];
         if(_loc6_ != null && this.var_441 >= 0)
         {
            _loc13_ = _loc6_[this.var_441];
            if(_loc13_ != null)
            {
               this.var_1452 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1168[this.var_445];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_758[this.var_444];
         var _loc9_:Array = this.var_1171[_loc8_];
         if(_loc9_ != null && this.var_446 >= 0)
         {
            _loc15_ = _loc9_[this.var_446];
            if(_loc15_ != null)
            {
               this.var_1453 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_444];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_116:
               ...
               if(this.var_442 < 0)
               {
                  this.var_442 = this.var_617.length - 1;
               }
               if(this.var_442 >= this.var_617.length)
               {
                  this.var_442 = 0;
               }
               this.var_443 = 0;
               this.var_947 = 0;
               _loc5_ = this.var_617[this.var_442];
               _loc6_ = this.var_950[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_947 = _loc6_.length;
               }
            ...
            case const_236:
               ...
               if(this.var_445 < 0)
               {
                  this.var_445 = this.var_757.length - 1;
               }
               if(this.var_445 == this.var_757.length)
               {
                  this.var_445 = 0;
               }
               this.var_441 = 0;
               this.var_949 = 0;
               _loc7_ = this.var_757[this.var_445];
               _loc8_ = this.var_1170[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_949 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_444 < 0)
               {
                  this.var_444 = this.var_758.length - 1;
               }
               if(this.var_444 >= this.var_758.length)
               {
                  this.var_444 = 0;
               }
               this.var_446 = 0;
               this.var_948 = 0;
               _loc9_ = this.var_758[this.var_444];
               _loc10_ = this.var_1171[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_948 = _loc10_.length;
               }
