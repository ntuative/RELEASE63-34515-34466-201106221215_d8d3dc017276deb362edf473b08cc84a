package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1053.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1053 = null;
         }
         if(this.var_1054 != null)
         {
            this.var_1054.removeEventListener(WindowKeyboardEvent.const_184,this.windowKeyEventProcessor);
            this.var_1054 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1053 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1053 != null)
         {
            this.var_1053.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1054 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1054 != null)
         {
            this.var_1054.addEventListener(WindowKeyboardEvent.const_184,this.windowKeyEventProcessor);
         }
         return true;
      }
