package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         if(this.var_28 != null)
         {
            this.var_28.unRegisterVisualization(this);
         }
         this.var_28 = null;
         this.reset();
         super.dispose();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_28 = (page.viewer.catalog as HabboCatalog).getClubBuyController();
         this.var_28.registerVisualization(this);
         this.var_28.requestOffers();
         return true;
      }
