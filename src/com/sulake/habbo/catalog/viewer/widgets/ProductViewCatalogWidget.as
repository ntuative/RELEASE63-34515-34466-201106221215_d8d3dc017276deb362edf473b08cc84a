package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_517:IDisplayObjectWrapper;
      
      private var var_1736:Point;
      
      private var var_516:IItemGridWindow;
      
      private var var_1441:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1163 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_191 != null)
         {
            ...
            this.var_517 = this.var_191.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_517 != null && _loc3_ != null)
            {
               this.var_191.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_517.width,this.var_517.height);
               if(_loc4_ != null)
               {
                  this.var_517.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1736 = new Point(this.var_96.x,this.var_96.y);
         this.var_516 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1441 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1163.text = _loc5_;
         this.var_944.height = this.var_944.textHeight + 5;
         this.var_1163.y = this.var_944.y + this.var_944.height;
         this.var_1163.height = Math.max(130,this.var_1163.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               ...
               case Offer.const_405:
                  ...
                  if(this.var_191 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_77 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_189)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_77:
                        if(_loc8_ != null && this.var_517 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_326,AvatarAction.const_629);
                                 _loc18_.appendAction(AvatarAction.const_379,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2308)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2308 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_96 != null && true)
         {
            ...
            this.var_96.x = this.var_1736.x;
            this.var_96.y = this.var_1736.y;
            if(param3 != null)
            {
