package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1667:int = 18;
      ...
      private var var_212:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_111,this.onTextWindowEvent);
         ...
         this.var_586 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_586 < 8)
         {
            return false;
         }
         this.var_2352 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_212 != null && this.var_212.length > 0)
         {
            this.var_414 = this.var_212[0];
         }
         else
         {
            this.var_414 = -1;
         }
         this._offers.add(this.var_586,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_212 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1667 && _loc2_ < this.var_212.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_586,this.var_212[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_212 != null && this.var_212.length > 0)
         {
            ...
            this.var_414 = this.var_212[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_586,this.var_414),this.getRaceLocalizationKey(this.var_586,this.var_414));
            }
         }
         return this.getRaceLocalizationKey(this.var_586,this.var_414);
      }
