package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1262 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         ...
         this.var_1263 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1263 != null)
         {
            this.var_1263.visible = false;
         }
      ...
      override public function dispose() : void
      {
         ...
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_224);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_224);
            this._soundManager.musicController.playSong(this.var_1020,HabboMusicPrioritiesEnum.const_224,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1020 = parseInt(_loc2_.extraParam);
            if(this.var_1263 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1262.text = _loc8_;
            }
         }
         else if(this.var_1262 != null)
         {
            this.var_1262.text = "";
         }
         if(this.var_457 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1020);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1020);
         }
         return -1;
      }
