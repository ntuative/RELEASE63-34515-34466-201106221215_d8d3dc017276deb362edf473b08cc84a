package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1627:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1599:XML;
      
      private static var var_1598:XML;
       
      
      private var var_2032:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1598 == null)
         {
            ...
            var_1598 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2032 == 4294967295)
            {
               this.var_2032 = _loc1_.color;
            }
            _loc1_.color = const_1627;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1909;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1751;
            }
         }
      }
      ...
      {
         this.var_67 = navigator.catalog.windowManager.buildFromXML(var_1598) as IItemListWindow;
         if(this.var_67 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1599) as IWindowContainer;
         }
         else
         {
