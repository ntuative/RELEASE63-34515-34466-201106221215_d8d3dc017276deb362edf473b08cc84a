package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3100:String = "magic.credits";
      
      private var var_3065:String = "magic.pixels";
      
      private var var_3066:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3065);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3066,true);
      }
