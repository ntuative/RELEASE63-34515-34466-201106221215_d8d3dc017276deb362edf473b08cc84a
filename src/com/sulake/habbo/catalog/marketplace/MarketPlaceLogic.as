package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2110:int = 1;
      
      public const const_2123:int = 2;
      
      public const const_2364:int = 3;
      ...
      private var var_2989:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2986,this.var_2988,this.var_2594,this.var_2987);
      }
      ...
      public function requestItemStats(param1:int, param2:int) : void
      {
         if(this._catalog)
         {
            ...
            this._catalog.method_8(param1,param2);
         }
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2110,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_499)
            {
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2878 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2554 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2123,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2819 || param1.furniTypeId != this.var_2820)
         {
            return;
         }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_116)
            {
