package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_729:uint = 1;
      ...
      private var var_1241:IRoomSession;
      ...
      private var var_230:CatalogViewer;
      
      private var var_348:ICatalogNavigator;
      ...
      private var var_231:ChargeConfirmationDialog;
      ...
      private var var_2942:Boolean = true;
      
      private var var_2141:Boolean = false;
      
      private var var_2941:GiftWrappingConfiguration;
      
      private var var_1380:ClubGiftController;
      
      private var var_596:ClubBuyController;
      ...
      private var var_1668:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_74,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1813);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_419.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_596.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2940 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_419.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_140,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_160 != null && this.var_160.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_721 == null)
            {
      ...
      {
         return this.var_160.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      
      private function isClubStatusBarEnabled() : Boolean
      {
         return this.var_160.getBoolean("club.status.bar.enabled",false);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_348.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_160.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_160.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_419.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_419.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_419.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      public function method_8(param1:int, param2:int) : void
      {
      ...
      {
         var _loc2_:Array = this.var_903.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_230.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_348 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_230 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_230.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_729) as IWindowContainer;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_74:
               this.var_2141 = param1.session.isPrivateRoom;
               this.var_1241 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1380 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_596 == null)
         {
            this.var_596 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_230 != null)
         {
            this.var_230.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1667 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_348.buildCatalogIndex(_loc2_);
         if(this.var_904 && this.var_904 != "")
         {
            this.var_348.openPage(this.var_904);
            this.var_904 = "";
            this.var_1112 = -1;
         }
         else if(this.var_1112 > -1)
         {
            this.var_348.openPageById(this.var_1112,this.var_2140);
            this.var_1112 = -1;
            this.var_2140 = -1;
            this.var_904 = "";
         }
         else if(this.var_1667 && this.var_2940)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_348.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1755));
         }
         else
         {
            this.var_348.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_230.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_230 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_230.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2939 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1335);
         }
         this.var_2939 = false;
         if(this.var_231 != null && !this.var_231.disposed)
         {
            this.var_231.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_108,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2942 && this._soundManager != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_249,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_942)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_258,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_249,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_258,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1315 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1380.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2941 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_231 == null || this.var_231.disposed)
         {
            this.var_231 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_231.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_903.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_903.add(_loc2_.productCode,_loc3_.slice());
            this.var_230.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_160.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_160.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_198)
         {
            _loc3_ = this.var_160.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_160.keyExists("catalog.drag_and_drop") || this.var_160.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1241 || !this.var_1241.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_234);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1381 && param1.type == RoomEngineObjectEvent.const_140)
         {
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_902);
            _loc5_ = this.var_1668;
            if(_loc5_ != null)
            {
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_333:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_234);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_160.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_729);
            if(_loc1_ != null)
            {
