package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_494:Conversations;
      ...
      {
         if(this._windowManager && this._communication && this.var_160 && this._localization && this._friendList && this.var_809 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_494 = new Conversations(new ConversationsDeps(this));
      ...
      {
         var _loc2_:Conversation = this.var_494.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_494.setSelected(_loc2_);
      ...
      {
         return !!this.var_494 ? this.var_494.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_494.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_494.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_160.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_906,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1254,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_494.addMessageAndUpdateView(param1);
         if(!this.var_202.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1189);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1228,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_494.addMessageAndUpdateView(_loc3_);
      }
