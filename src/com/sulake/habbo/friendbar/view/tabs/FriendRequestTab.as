package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2042:String = "friendRequestTabXML";
      ...
      private static const const_79:uint = 16435481;
      ...
      private static var var_1540:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1540 ? var_1540 : new FriendRequestTab();
         _loc2_.var_163 = false;
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               _loc3_ = IBitmapWrapperWindow(_loc2_._window.findChildByName(const_318));
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_371,WindowStyle.const_104,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_396,WindowStyle.const_104,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2035:
                  var_352.acceptFriendRequest(var_165.id);
                  break;
               case const_1404:
                  if(selected)
                  {
                  ...
                  break;
               case const_1034:
                  var_352.declineFriendRequest(var_165.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1034)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1580;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(!disposed)
         {
            if(friend)
            {
               ...
               {
                  _loc3_ = _window.findChildByName(const_318) as IBitmapWrapperWindow;
                  if(_loc3_)
                  {
