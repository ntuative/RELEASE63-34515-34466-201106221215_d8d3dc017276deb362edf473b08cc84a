package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1637:String = "entity_xml";
      
      private static const const_1639:String = "facebook_piece_xml";
      
      private static const const_1638:String = "controls_piece_xml";
      ...
      protected static const const_1416:String = "facebook";
      
      protected static const const_1415:String = "controls";
      
      protected static const const_318:String = "canvas";
      
      protected static const const_684:String = "name";
      
      protected static const const_1038:String = "btn_message";
      
      protected static const const_1035:String = "icon_message";
      ...
      protected static const const_570:String = "notification";
      
      private static const const_79:uint = 10338138;
      
      private static const const_1048:uint = 13891476;
      
      private static const const_1126:String = null;
      
      private static const const_716:String = "icon_tag_notify";
      
      private static const const_1636:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_484:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1416) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1415) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_570,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1639).content as XML) as IWindowContainer;
               _loc3_.name = const_1416;
               _loc6_ = _loc3_.getChildByName(const_684) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2201.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1638).content as XML) as IWindowContainer;
               _loc3_.name = const_1415;
               _loc8_ = _loc3_.getChildByName(const_1038);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_165)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(PIECES)).getListItemByName(const_467) as IWindowContainer;
            _loc1_.findChildByName(const_684).caption = this.var_165.name;
            var_2201.crop(_loc1_.getChildByName(const_684) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_318));
            _loc2_.bitmap = var_502.getAvatarFaceBitmap(this.var_165.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_484.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1637).content as XML) as IWindowContainer;
         var _loc2_:IBitmapWrapperWindow = IBitmapWrapperWindow(_loc1_.findChildByName(const_318));
         var _loc3_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_467));
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            param1.width = name_2;
            param1.height = name_1;
            param1.color = const_79;
            _loc4_ = IBitmapWrapperWindow(param1.findChildByName(const_318));
            _loc4_.bitmap = null;
            ITextWindow(param1.findChildByTag("label")).underline = false;
            purgeEntityPieces(param1);
            if(const_484.indexOf(param1) == -1)
            {
               const_484.push(param1);
            }
         }
      }
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1038:
               case const_1035:
                  this.removeNotificationToken(FriendNotification.const_411,true);
                  if(var_352 && this.var_165)
                  {
                     var_352.startConversation(this.var_165.id);
                     this.method_1(true);
                     if(param1.window.name == const_1035)
                     {
               ...
               case const_1414:
                  if(var_352 && this.var_165)
                  {
                     var_352.followToRoom(this.var_165.id);
                     this.method_1(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         {
            case FriendNotification.const_1322:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2206);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_716;
               break;
            case FriendNotification.const_1325:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2206);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_716;
               break;
            case FriendNotification.const_411:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1035;
