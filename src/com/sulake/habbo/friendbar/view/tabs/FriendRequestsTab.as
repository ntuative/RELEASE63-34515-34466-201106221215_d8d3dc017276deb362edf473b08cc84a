package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2034:String = "friendRequestsTabXML";
      ...
      protected static const const_2037:String = "badge_counter";
      
      protected static const const_2036:String = "button_accept_all";
      
      protected static const const_2038:String = "click_area_discard_all";
      
      protected static const const_1404:String = "button_close";
      
      protected static const const_2035:String = "button_accept";
      
      protected static const const_1032:String = "click_area_discard";
      
      protected static const const_1409:String = "text_discard";
      
      private static var var_1540:FriendRequestsTab;
      
      private static const const_79:uint = 4294625561;
      
      private static const const_1048:uint = 4294957414;
      
      private static const const_1581:uint = 4289431312;
      
      private static const const_1579:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1580:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1540 ? var_1540 : new FriendRequestsTab();
         _loc2_.var_163 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2037).caption = String(param1.length);
         return _loc2_;
      }
                  ...
                  if(!this.var_1950)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        while(_loc8_ < this._requests.length)
                        {
                           ...
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1581) : uint(const_1579);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_684).caption = _loc5_.name;
                           _loc6_ = _loc4_.getChildByName(const_318) as IBitmapWrapperWindow;
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2034).content as XML) as IWindowContainer;
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_ = IBitmapWrapperWindow(param1.findChildByName(const_318));
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1033)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1404:
                  ...
                  break;
               case const_2036:
                  var_352.acceptAllFriendRequests();
                  break;
               case const_2038:
                  var_352.declineAllFriendRequests();
                  break;
               case const_2035:
                  var_352.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1032:
                  var_352.declineFriendRequest(param2.parent.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1409)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1032)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1409)).textColor = const_1580;
            }
         }
      }
         ...
         if(_loc3_)
         {
            ...
            if(_loc4_)
            {
               ...
               while(_loc6_ < _loc4_.numListItems)
               {
                  ...
                  {
                     _loc7_ = _loc5_.getChildByName(const_318) as IBitmapWrapperWindow;
