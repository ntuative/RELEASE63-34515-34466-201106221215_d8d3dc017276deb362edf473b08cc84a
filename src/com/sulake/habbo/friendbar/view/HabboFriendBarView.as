package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends Component implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1556:int = 127;
      ...
      private static const const_1557:Boolean = false;
      
      private static const const_695:int = 3;
      
      private static const const_1548:String = "arrow";
      
      private static const const_1552:String = "left";
      
      private static const const_1551:String = "right";
      
      private static const const_1549:String = "bar_xml";
      
      private static const const_1546:String = "toggle_xml";
      
      private static const const_70:String = "container";
      
      private static const const_1080:String = "wrapper";
      
      private static const const_1559:String = "border";
      
      private static const const_693:String = "list";
      
      private static const const_467:String = "header";
      
      private static const const_318:String = "canvas";
      
      private static const ICON:String = "icon";
      
      private static const PIECES:String = "pieces";
      
      private static const const_1561:String = "button_left";
      
      private static const const_1555:String = "button_right";
      
      private static const const_1560:String = "button_left_page";
      
      private static const const_1558:String = "button_right_page";
      
      private static const const_1554:String = "button_left_end";
      
      private static const const_1545:String = "button_right_end";
      
      private static const const_1404:String = "button_close";
      
      private static const const_1553:String = "button_open";
      
      private static const const_1547:String = "messenger";
      ...
      private var var_809:IAvatarRenderManager;
      
      private var var_54:IHabboFriendBarData;
      ...
      private var var_1248:ITab;
      
      private var var_1007:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1511:TextCropper;
      
      private var var_545:FriendListIcon;
      
      private var var_387:MessengerIcon;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_54)
            {
               if(!this.var_54.disposed)
               {
                  if(this.var_54.events)
                  {
                     this.var_54.events.removeEventListener(FriendBarUpdateEvent.const_872,this.onRefreshView);
                     this.var_54.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_54.events.removeEventListener(FriendRequestUpdateEvent.const_903,this.onFriendRequestUpdate);
                     this.var_54.events.removeEventListener(NewMessageEvent.NEW_INSTANT_MESSAGE,this.onNewInstantMessage);
                     this.var_54.events.removeEventListener(NotificationEvent.const_827,this.onFriendNotification);
                  }
                  this.var_54.release(new IIDHabboFriendBarData());
                  this.var_54 = null;
               }
            }
            if(this._windowManager)
            {
               ...
               {
                  this._windowManager.getWindowContext(const_476).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
            ...
            if(this.var_809)
            {
               if(!this.var_809.disposed)
               {
                  this.var_809.release(new IIDAvatarRenderManager());
                  this.var_809 = null;
               }
            }
            if(this.var_1006)
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_218)
         {
            ...
            if(this.var_51)
            {
               this.var_218.x = this.var_51.x;
               this.var_218.y = this.var_51.y;
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1007;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_51.findChildByName(const_70) as IWindowContainer;
         ...
         var _loc6_:int = this.var_54.numFriends;
         var _loc7_:int = this.var_54.numFriendRequests;
         var _loc8_:int = this.maxNumOfTabsVisible;
         var _loc9_:int = _loc6_ + (!!this.var_1510 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(_loc7_ > 0)
         {
            if(this._startIndex == 0)
            {
               if(this.var_72.length < _loc8_)
               {
                  if(_loc7_ == 1)
                  {
                     _loc12_ = this.var_54.getFriendRequestAt(0);
                  ...
                  {
                     _loc14_ = FriendRequestsTab.allocate(this.var_54.getFriendRequestList());
                     this.var_72.push(_loc14_);
                     _loc3_.addListItem(_loc14_.window);
                  }
               }
         ...
         while(_loc5_ < _loc6_ + _loc11_)
         {
            ...
            _loc13_ = this.var_54.getFriendAt(_loc5_);
      ...
      {
         this.var_54 = param2 as IHabboFriendBarData;
         this.var_54.events.addEventListener(FriendBarUpdateEvent.const_872,this.onRefreshView);
         this.var_54.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_54.events.addEventListener(FriendRequestUpdateEvent.const_903,this.onFriendRequestUpdate);
         this.var_54.events.addEventListener(NewMessageEvent.NEW_INSTANT_MESSAGE,this.onNewInstantMessage);
         this.var_54.events.addEventListener(NotificationEvent.const_827,this.onFriendNotification);
      }
      ...
      {
         this.var_1006 = param2 as IHabboLocalizationManager;
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_352 = this.var_54;
         Tab.var_502 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = this._windowManager;
         Tab.var_2206 = this.var_1006;
         Tab.var_2201 = this.var_1511;
         Token.WINDOWING = this._windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1549);
         this.var_51 = this._windowManager.buildFromXML(_loc1_.content as XML,const_476) as IWindowContainer;
         this.var_51.x = const_694;
         this.var_51.y = this.var_51.parent.height - (this.var_51.height + const_1550);
         this.var_51.width = this.var_51.parent.width - (const_694 + const_1081);
         this.var_51.setParamFlag(WindowParam.const_263,true);
         this.var_51.procedure = this.barWindowEventProc;
         if(const_1557)
         {
            _loc1_ = assets.getAssetByName(const_1546);
            this.var_218 = this._windowManager.buildFromXML(_loc1_.content as XML,const_476) as IWindowContainer;
            this.var_218.x = this.var_51.x;
            this.var_218.y = this.var_51.y;
            this.var_218.setParamFlag(WindowParam.const_263,true);
            this.var_218.visible = false;
            this.var_218.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_51.findChildByName(const_1082));
         ...
         this.var_545 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_51.findChildByName(const_1547));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_387 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_387.enable(false);
         this.visible = true;
         this._windowManager.getWindowContext(const_476).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
      }
      
      private function onAvatarRendererAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_809 = param2 as IAvatarRenderManager;
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(this.var_809)
         {
            _loc3_ = this.var_809.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_51.findChildByName(const_693) as IItemListWindow;
         var _loc4_:int = this.var_54.numFriends;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc2_ = this.var_54.getFriendAt(_loc5_);
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     ...
                     if(_loc10_)
                     {
                        _loc11_ = IWindowContainer(_loc10_.getListItemByName(const_467));
                        if(_loc11_)
                        {
                           _loc12_ = _loc11_.findChildByName(const_318) as IBitmapWrapperWindow;
         ...
         var _loc6_:Array = this.var_54.getFriendRequestList();
      ...
      {
         return this.var_1007 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1007 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_561);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_545)
         {
            this.var_545.notify(this.var_54.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_387)
         {
            if(param1.notify)
            {
               this.var_387.notify(true);
            }
            else
            {
               this.var_387.enable(true);
            }
         }
      }
      ...
      {
         var _loc2_:FriendEntityTab = this.getFriendEntityTabByID(param1.var_3018);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_54.numFriends + (!!this.var_1510 ? 1 : 0) + (this.var_54.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               case const_1561:
      ...
      {
         var _loc2_:Icon = param1.window.name == const_1082 ? this.var_545 : this.var_387;
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(_loc2_ is FriendListIcon)
               {
                  this.var_54.toggleFriendList();
                  _loc2_.notify(false);
               }
               else if(_loc2_ is MessengerIcon)
               {
                  this.var_54.toggleMessenger();
                  _loc2_.notify(false);
               }
               break;
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_51.findChildByName(const_1080) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1548,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1552,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1551,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
            ...
            if(this.var_51)
            {
               ...
               if(!param1)
               {
                  ...
                  else if(_loc2_ > this.var_72.length)
                  {
                     ...
                     else if(this.var_72.length < this.var_54.numFriends + (!!this.var_1510 ? 1 : 0))
                     {
                        param1 = true;
                     }
                     else if(this.numFriendEntityTabsVisible < this.var_54.numFriends)
                     {
                        param1 = true;
                     }
                  }
      ...
      {
         var _loc1_:IWindowContainer = this.var_51.findChildByName(const_70) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1080) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_693) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1556 + _loc3_.spacing);
      }
