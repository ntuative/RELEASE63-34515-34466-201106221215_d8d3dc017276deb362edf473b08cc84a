package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1058:Boolean = false;
      
      private static const const_686:String = "Navigation";
      
      private static const const_687:String = "Friend Bar";
      
      private static const const_1486:String = "go.friendbar";
      
      private static const const_1487:String = "chat_btn_click";
      
      private static const const_1483:String = "find_friends_btn_click";
      
      private static const const_1059:String = "Toolbar";
      
      private static const const_1056:String = "open";
      
      private static const const_1057:String = "close";
      
      private static const const_1484:String = "FRIENDLIST";
      
      private static const const_1485:String = "MESSENGER";
       
      
      private var var_962:IHabboConfigurationManager;
      
      private var var_92:IHabboCommunicationManager;
      
      private var var_83:IHabboFriendList;
      
      private var var_214:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_962)
            {
               this.var_962.release(new IIDHabboConfigurationManager());
               this.var_962 = null;
            }
            if(this.var_92)
            {
               this.var_92.release(new IIDHabboCommunicationManager());
               this.var_92 = null;
            }
            if(this.var_83)
            {
               if(!this.var_83.disposed)
               {
                  ...
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_232,this.onFriendRequestEvent);
               }
            ...
            if(this.var_214)
            {
               this.var_214.release(new IIDHabboMessenger());
               this.var_214 = null;
            }
            this.var_110 = null;
      ...
      {
         return this.var_316.getValue(param1);
      }
      ...
      {
         var _loc3_:int = this.var_110.indexOf(param1);
         if(_loc3_ > -1 && _loc3_ != param2)
         {
            this.var_110.splice(_loc3_,1);
            this.var_110.splice(param2,0,param1);
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_92)
         {
            this.var_92.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_686,const_687,const_1486));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_214)
         {
            this.var_214.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_92)
            {
               this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_686,const_687,const_1487));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_92)
         {
            this.var_92.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_686,const_687,const_1483));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               ...
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1059,const_1484,!!this.var_83.isOpen() ? const_1056 : const_1057));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_214)
         {
            ...
            {
               this.var_214.toggleMessenger();
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1059,const_1485,!!this.var_214.isOpen() ? const_1056 : const_1057));
               }
            }
         }
      }
      ...
      {
         this.var_962 = param2 as IHabboConfigurationManager;
         this.var_2393 = this.var_962.getBoolean("friendbar.notifications.enabled",false);
         this.var_1788 = this.var_962.getBoolean("friendbar.requests.enabled",false);
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_92 = param2 as IHabboCommunicationManager;
         this.var_92.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_92.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_92.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_92.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_92.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_92.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_92.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
         this.var_92.addHabboConnectionMessageEvent(new FriendNotificationEvent(this.onFriendNotification));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_214 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_83.events.addEventListener(FriendRequestEvent.const_232,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_316.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_316.remove(_loc8_);
               this.var_110.splice(this.var_110.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_316.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_319)
            {
               ...
               this.var_110.splice(0,0,_loc3_);
               this.var_316.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_319)
            {
               if(this.var_316.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_110 = !!const_319 ? this.sortByNameAndOnlineStatus(this.var_110) : this.sortByName(this.var_110);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_771 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_214)
         {
            if(this.var_214.isOpen())
            {
               _loc4_ = this.var_214.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_771)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_771));
            this.makeNotification(String(this.var_771),FriendNotification.const_411,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_771 = _loc2_.senderId;
         if(this.var_214 && !this.var_214.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_771));
            this.makeNotification(String(this.var_771),FriendNotification.const_411,null,true,false);
         }
      }
