package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_643:RoomInfoViewCtrl;
      
      private var var_1259:RoomCreateViewCtrl;
      ...
      private var var_2555:RoomThumbnailRenderer;
      
      private var var_974:GuestRoomPasswordInput;
      
      private var var_327:GuestRoomDoorbell;
      
      private var var_1258:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2556 = new Array();
         ...
         this.var_643 = new RoomInfoViewCtrl(this);
         this.var_1259 = new RoomCreateViewCtrl(this);
         this.var_2555 = new RoomThumbnailRenderer(this);
         this.var_974 = new GuestRoomPasswordInput(this);
         this.var_327 = new GuestRoomDoorbell(this);
         this.var_453 = new Tabs(this);
         this.var_1258 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_364,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_160.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_326.startSearch(Tabs.const_217,Tabs.const_451,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_326.startSearch(Tabs.const_244,Tabs.const_254);
         this.var_453.getTab(Tabs.const_244).tabPageDecorator.tabSelected();
      }
