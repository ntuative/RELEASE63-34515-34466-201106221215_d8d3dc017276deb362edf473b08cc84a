package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1185:TextFieldManager;
      
      private var var_46:Array;
      
      private var var_1186:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,80,"g"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,74,"h"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,416,"o"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,352,"p"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,304,"q"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,336,"r"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,748,"u"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_36,438,"v"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,540,"t"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,512,"w"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,396,"x"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,440,"y"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,456,"z"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1186.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1773 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1773 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_67 = IItemListWindow(this.var_193.findChildByName("item_list"));
         ...
         this.var_1185 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_193.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1185.goBackToInitialState();
         this.var_1185.input.textBackgroundColor = 4294967295;
         this.var_1186 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_36))
         {
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_54:
               return true;
            case HabboClubLevelEnum.const_36:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_36);
            case HabboClubLevelEnum.const_44:
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_70,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1185.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1185.getText();
         var _loc3_:String = "model_" + this.var_1186.name;
