package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_785:ICheckBoxWindow;
      
      private var var_1814:ITextWindow;
      
      private var var_971:IDropMenuWindow;
      
      private var var_972:IDropMenuWindow;
      
      private var var_2436:IWindowContainer;
      ...
      {
         this.var_375 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_375));
      ...
      {
         if(param1 != this.var_375 || this.var_1211 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1211 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1960)
         {
            this.var_786.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1990)
         {
            this.var_786.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1744)
         {
            this.var_1207.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1760)
         {
            this.setTagError(this.var_970,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            this.setTagError(this.var_970,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_973,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1924)
         {
            this.var_974.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_786.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_667,this.onDoorModePasswordUnselect);
         ...
         this.var_786 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1207 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_970 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_973 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_974 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1208 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1209 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1212 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1213 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_785 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1814 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_971 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_972 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2436 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         ...
         this.var_1815 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1483 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_241 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1206 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1481 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1481.mouseThreshold = 0;
         this.var_1481.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1206.visible = false;
         if(!this.var_1482)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1815.visible = this.var_1482;
         this.populateForm();
         if(this.var_784)
         {
         ...
         else
         {
            ...
            this.var_1483.visible = true;
            this.var_2436.visible = this.var_1482;
            this.var_1205.height = Util.getLowestPoint(this.var_1205) + 4;
         }
         this.var_1481.text = !!this.var_784 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1205.name,this.var_1210.name,this.var_1483.name,this.var_1815.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_786.setText(_loc1_.name);
         this.var_1207.setText(_loc1_.description);
         this.var_974.setText("");
         ...
         {
            case RoomSettingsData.const_235:
         ...
         this.setTag(this.var_970,_loc1_.tags[0]);
         ...
         {
            this.disableWindow(this.var_785);
            this.disableWindow(this.var_971);
            this.disableWindow(this.var_972);
            this.disableWindow(this.var_1814);
         }
         else
         {
            this.enableWindow(this.var_785);
            this.enableWindow(this.var_971);
            this.enableWindow(this.var_972);
            this.enableWindow(this.var_1814);
         }
         if(this.var_785)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_785.unselect();
            }
         }
         if(this.var_971)
         {
            this.var_971.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_972)
         {
            this.var_972.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowPets = this.var_1209.isSelected;
         _loc2_.allowFoodConsume = this.var_1212.isSelected;
         _loc2_.allowWalkThrough = this.var_1213.isSelected;
         _loc2_.hideWalls = this.var_785.isSelected;
         _loc2_.wallThickness = this.var_971.selection - 2;
         _loc2_.floorThickness = this.var_972.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_970,_loc2_.tags);
         this.addTag(this.var_973,_loc2_.tags);
         this.clearErrors();
         this.var_1211 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_375);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_375]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_70,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_375));
      }
