package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_136:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2555 = new RoomThumbnailRenderer(param1);
         this.var_1026 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_201,this.var_136);
         if(this.var_136.ownerName != "" && this.var_136.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_201,!!this.var_136.event ? this.getEventCtg(this.var_136.categoryId) : this.getRoomCtg(this.var_136.categoryId));
         this.refreshRoomDesc(this.var_201,this.var_136);
         this.refreshExtraCont();
         this.refreshInfo(this.var_201,"trading_allowed",this.var_136.allowTrading);
         this.refreshInfo(this.var_201,"doormode_doorbell",this.var_136.doorMode == 1);
         this.refreshInfo(this.var_201,"doormode_password",this.var_136.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_201,this.var_136.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1026.refreshTags(_loc1_,this.var_136.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_136.score);
         if(this.var_136.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_136.eventCreationTime);
         }
         this.var_2555.refreshThumbnail(_loc1_,this.var_136.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_217,Tabs.const_300,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
