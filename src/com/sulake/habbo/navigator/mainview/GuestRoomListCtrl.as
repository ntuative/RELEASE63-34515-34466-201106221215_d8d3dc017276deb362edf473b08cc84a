package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_562:RoomPopupCtrl;
      
      private var var_602:IScrollbarWindow;
      
      private var var_1160:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_562 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1160 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_602 = IScrollbarWindow(this.var_193.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_197,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1911,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_235,null,0);
         ...
         this.var_1160.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_562.visible && this.var_2627)
         {
            return;
         }
         ...
         this.var_562.room = _loc4_;
         this.var_562.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1548.tags[0];
            this.var_1548.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2628 - _loc2_.stageX);
         this.var_2628 = _loc2_.stageX;
         this.var_2627 = _loc3_ > 2;
      }
   }
}
