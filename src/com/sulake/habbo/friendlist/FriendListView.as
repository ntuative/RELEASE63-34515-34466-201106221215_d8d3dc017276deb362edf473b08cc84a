package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1458:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1972:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1972 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1458;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1114 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_276 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1972.prepare(this.var_1114);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1267,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1321,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_752,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_861,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_752,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_861,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1549 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1549.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1973 == -1 ? 0 : int(this.var_17.height - this.var_1973);
         var _loc4_:int = this.var_1971 == -1 ? 0 : int(this.var_17.width - this.var_1971);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_276.y = Util.getLowestPoint(this.var_17.content);
         this.var_276.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1200,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_752,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1267,false);
         ...
         this.var_1973 = this.var_17.height;
         this.var_1971 = this.var_17.width;
