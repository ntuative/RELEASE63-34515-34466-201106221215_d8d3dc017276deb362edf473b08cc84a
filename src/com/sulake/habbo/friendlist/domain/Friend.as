package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2095:int = "F".charCodeAt(0);
      
      public static const const_2124:int = "M".charCodeAt(0);
      ...
      private var var_1197:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1093 = param1.gender;
         this.var_887 = param1.online;
         this.var_1795 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1742 = param1.motto;
         this.var_1740 = param1.lastAccess;
         this.var_1524 = param1.categoryId;
         this.var_1741 = param1.realName;
