package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2084:String = "no_reqs_info";
      ...
      private var var_2103:IContainerButtonWindow;
      
      private var var_2104:IContainerButtonWindow;
      ...
      {
         this.var_2103 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2104 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2104.procedure = this.onDismissAllButtonClick;
         this.var_2103.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_461)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1347)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_423 && _loc2_.state != FriendRequest.const_461)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_461;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_232,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_423 && _loc2_.state != FriendRequest.const_461)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_232,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2103,_loc1_);
         this.setEnabled(this.var_2104,_loc1_);
      }
