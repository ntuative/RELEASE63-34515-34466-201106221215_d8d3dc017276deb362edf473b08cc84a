package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboFriendList, param2:int, param3:int, param4:String)
      {
         ...
         this.var_475.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_60 == null)
         {
            this.var_60 = IWindowContainer(this._friendList.getXmlWindow(this.var_1147));
         ...
         this.var_60.x = _loc4_.x - _loc3_.x + this.var_2701 + param2.width;
