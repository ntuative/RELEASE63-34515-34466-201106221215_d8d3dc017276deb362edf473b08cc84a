package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_755:ISessionDataManager;
      
      private var var_2318:FriendListLookAndFeel;
      ...
      var var_116:FriendCategories;
      
      private var var_118:FriendRequests;
      
      private var var_1745:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1050:IHabboNotifications;
      
      private var var_614:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2318 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_116 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1745 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1050)
         {
            this.var_1050.release(new IIDHabboNotifications());
            this.var_1050 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_755)
         {
            this.var_755.release(new IIDSessionDataManager());
            this.var_755 = null;
         }
         super.dispose();
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_116.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_112);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_435);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_116.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_364,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_809.createAvatarImage(param1,AvatarScaleType.const_109,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_160.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_160.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1050 = param2 as IHabboNotifications;
      ...
      {
         this.var_755 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_116.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_1181,this.getText("friendlist.friends")));
         this.var_116.addCategory(new FriendCategory(FriendCategory.const_412,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_116.addFriend(new Friend(_loc4_));
         }
         ...
         if(this.var_116.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_116.findCategory(FriendCategory.const_412);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_118.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_118.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_453.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_453.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1745.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_116.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_116.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_453.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_453.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_755 || !this.var_118)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_755.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_118.vipLimit;
         }
         else if(this.var_755.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_36))
         {
            _loc2_ = this.var_118.clubLimit;
         }
         if(_loc2_ > this.var_118.limit)
         {
            this.var_118.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_116 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_116.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
