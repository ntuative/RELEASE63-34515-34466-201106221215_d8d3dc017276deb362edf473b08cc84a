package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1115:uint = 11;
      ...
      private var var_224:IHabboFriendList;
      
      private var var_1323:IHabboWindowManager;
      ...
      private var var_290:PerformanceTracker = null;
      
      private var var_476:FramerateTracker = null;
      
      private var var_291:LatencyTracker = null;
      
      private var var_677:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_290 = new PerformanceTracker();
         this.var_476 = new FramerateTracker();
         this.var_291 = new LatencyTracker();
         this.var_677 = new LagWarningLogger();
         this.var_477 = new ToolbarClickTracker(this);
         this.var_1595 = new Array(const_1115);
         var _loc4_:int = 0;
         while(_loc4_ < const_1115)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1745,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1976,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1028,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1368,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1323)
            {
               this.var_1323.release(new IIDHabboWindowManager());
               this.var_1323 = null;
            }
            if(this.var_346)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_362,this.onZoomToggle);
               }
            ...
            if(this.var_224)
            {
               ...
               {
                  Component(this.var_224).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_224).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_224).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_224).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_224).events.removeEventListener(HabboFriendListTrackingEvent.const_573,this.onFriendlistTrackingEvent);
               }
               this.var_224.release(new IIDHabboFriendList());
               this.var_224 = null;
            }
            if(this.var_198)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_194,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_352,this.onRoomAction);
               }
      ...
      {
         this.var_160 = IHabboConfigurationManager(param2);
         if(this.var_160)
         {
            if(this.var_291 != null)
            {
               this.var_291.configuration = this.var_160;
            }
            if(this.var_290 != null)
            {
               this.var_290.configuration = this.var_160;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1768);
            if(this.var_160)
            {
               if(this.var_677 != null)
               {
                  this.var_677.configure(this.var_160);
               }
               if(this.var_476 != null)
               {
                  this.var_476.configure(this.var_160);
               }
               if(this.var_477 != null)
               {
                  this.var_477.configure(this.var_160);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_255,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_747,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_72,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_606,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_291 != null)
            {
               this.var_291.communication = this._communication;
               this.var_291.connection = param1;
            }
            if(this.var_677 != null)
            {
               this.var_677.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_747)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1965);
         }
         else if(param1.type == HabboHotelViewEvent.const_606)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1896);
         }
         else if(param1.type == HabboHotelViewEvent.const_72)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1808);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_952:
               this.trackLoginStep(HabboLoginTrackingStep.const_1764,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_233:
               ...
               break;
            case HabboCommunicationEvent.const_255:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_255);
               if(this.var_291 != null)
               {
                  this.var_291.init();
               }
      ...
      {
         this.var_1323 = IHabboWindowManager(param2);
         if(this.var_1323)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_160)
            {
               if(this.var_160.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_160.getKey("client.fatal.error.url");
                  ...
                  if(this.var_290 != null)
                  {
                     _loc4_["null"] = this.var_290.flashVersion;
                     _loc4_["null"] = this.var_290.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1361);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1361,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_362,this.onZoomToggle);
      }
      ...
      {
         this.var_224 = param2 as IHabboFriendList;
         Component(this.var_224).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_224).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_224).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_224).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_224).events.addEventListener(HabboFriendListTrackingEvent.const_573,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_573:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2770)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1843);
            this.var_2770 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1368,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1028,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_194,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_352,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_346 = param2 as IAdManager;
         this.var_346.events.addEventListener(AdEvent.const_613,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_194)
         {
            if(this.var_2029 < 1)
            {
               if(!this.var_333)
         ...
         else if(param1.type == RoomEngineEvent.const_352)
         {
            if(this.var_333)
            {
               this.var_333.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_476)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_476.frameRate),_loc2_);
                  ++this.var_2029;
               }
            }
         }
      ...
      {
         if(this.var_160 != null && !Boolean(this.var_160.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_677.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_573 > -1 && _loc2_ < this.var_573)
         {
            ++this.var_2030;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2030);
         }
         if(this.var_573 > -1 && _loc2_ - this.var_573 > 15000)
         {
            ++this.var_2031;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2031);
         }
         this.var_573 = _loc2_;
         if(this.var_290 != null)
         {
            this.var_290.update(param1,this.var_573);
         }
         if(this.var_291 != null)
         {
            this.var_291.update(param1,this.var_573);
         }
         if(this.var_476 != null)
         {
            this.var_476.trackUpdate(param1,this,this.var_573);
         }
         if(this.var_677 != null)
         {
            this.var_677.update(this.var_573);
         }
      }
   }
}
