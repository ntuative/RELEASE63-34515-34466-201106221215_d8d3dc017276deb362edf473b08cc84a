package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_254 = param2;
         this.var_779 = [];
         this.var_779.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_779.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_779)
         {
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_793,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_859,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_793,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_859,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_481);
      ...
      public function stopPlaying() : void
      {
         this.var_481 = -1;
         this.var_686 = false;
         this.var_254.stop(HabboMusicPrioritiesEnum.const_137);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_254.playSong(param1,HabboMusicPrioritiesEnum.const_137,_loc3_,0,0,0))
         {
