package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      private var var_686:Boolean = false;
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_779 = [];
         this.var_779.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_779.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_779.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         if(param1 < 0 || param1 >= this.var_570.length)
         {
            return null;
         }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_686 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_254.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_137,_loc3_.syncCount / 1000,0,1,1);
            this.var_481 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_2004 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_105,HabboMusicPrioritiesEnum.const_137,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_843.indexOf(_loc5_) < 0)
               {
                  this.var_843.push(_loc5_);
                  this.var_254.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_570.push(_loc7_);
            _loc4_++;
         }
         if(this.var_843.length == 0)
         {
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_570[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_843.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_843.splice(_loc3_,1);
         }
         if(this.var_843.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_102));
