package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1602:int = 60;
      
      private static const const_1604:int = 25165823;
      
      private static const const_1603:int = 16777215;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_770,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1051.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1355:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1841:
               ...
               case HabboSoundTypesEnum.const_1335:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1741:
            ...
            this.var_1051.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_160.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_160.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1299.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_284,events);
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_284.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1050.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_160.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2686 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1050 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_160 == null || this._connection == null || this._roomEngine == null || this.var_254 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1821,this.var_834));
         this.var_834 = -1;
         this.var_833 = null;
      }
      ...
      {
         this.var_990 = param1;
         this.var_254.updateVolume(this.var_990);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_662.getValue(param1) != null)
         {
            ...
            if(this.var_284.getValue(_loc2_) == null)
            {
               this.var_1561.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1561,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1561,_loc2_,TraxSample.const_1899,TraxSample.const_1970);
               this.var_284.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1300.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1602 && this.var_1300.length > 0)
            {
               _loc3_ = this.var_1300.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_662.length == 0 && this.var_834 != -1)
            {
               this.var_833.ready = true;
               _loc4_ = this.var_834;
               this.var_834 = -1;
               this.var_833 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_770,_loc4_));
               if(this.var_2686)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_833 == null && this.var_1299.length > 0)
         {
            _loc1_ = this.var_1299.getKey(0);
            _loc2_ = this.var_1299.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_770,_loc1_));
               }
               else
               {
                  this.var_833 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_284.length)
         {
            _loc5_ = this.var_284.getKey(_loc4_);
            _loc6_ = this.var_284.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1604)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1603 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_284.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_284.remove(_loc11_);
               }
