package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private var var_602:IScrollbarWindow;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_796 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_796.toggle();
         this.var_1851 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1502.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1502[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_602 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_67.spacing = const_1527;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1528;
         ...
         new PendingImage(this._questEngine,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_red_bitmap")),"quest_counterbkg_disabled");
         new PendingImage(this._questEngine,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_blue_bitmap")),"quest_counterbkg_active");
         new PendingImage(this._questEngine,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_green_bitmap")),"quest_counterbkg_completed");
         new PendingImage(this._questEngine,IBitmapWrapperWindow(_loc5_.findChildByName("completed_pic_bitmap")),"category_completed");
         _loc3_.x = _loc2_.x + _loc2_.width + const_1526;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1529;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1851 && !this.var_1852)
            {
               this.var_1851 = false;
