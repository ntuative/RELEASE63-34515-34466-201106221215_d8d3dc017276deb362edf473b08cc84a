package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1659:int = 56;
      
      private static const const_720:int = 5;
      
      private static const const_1620:int = 5;
      
      private static const const_1132:Point = new Point(8,8);
      
      private static const const_1658:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this._window.center();
            _loc8_ = this._questEngine.questController.questsList.createListEntry();
            _loc8_.x = const_1132.x;
            _loc8_.y = const_1132.y;
         ...
         this._questEngine.questController.questsList.refreshEntryDetails(_loc8_,param1);
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1620;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_720);
         var _loc7_:IWindowContainer = IWindowContainer(_loc8_.findChildByName("quest_container"));
         _loc7_.height += _loc5_ + _loc6_;
         this._questEngine.questController.questsList.setEntryHeight(_loc8_);
         this._window.height = _loc8_.height + const_1659;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_720 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_720 - _loc6_.height;
      ...
      {
         return this.var_129.waitPeriodSeconds < 1 && const_1658.indexOf(this.var_129.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this._questEngine.localization.hasKey(this.var_129.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this._questEngine.localization.hasKey(this.var_129.getCampaignLocalizationKey() + ".searchtag");
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._questEngine.openCatalog(this.var_129);
            }
            else if(this.hasNavigatorLink())
            {
               this._questEngine.openNavigator(this.var_129);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1501 = NextQuestTimer.const_768;
         var _loc2_:Boolean = this._questEngine.questController.questsList.refreshDelay(this._window,this.var_129);
         if(_loc2_)
         {
