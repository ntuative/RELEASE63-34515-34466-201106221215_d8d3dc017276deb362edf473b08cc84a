package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1619:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this._questEngine.localization.getKey("quests.completed.cataloglink." + this.var_129.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_129.activityPointType;
         this._questEngine.localization.registerParameter(_loc2_,"amount",this.var_129.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this._questEngine.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this._questEngine.localization.getKey(!!this.var_129.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         ...
         this._questEngine.setupCampaignImage(this._window,param1,this.var_129.lastQuestInCampaign);
         ...
         _loc3_.height = Math.max(const_1619,_loc3_.textHeight + const_1620);
      ...
      {
         this._questEngine.localization.registerParameter(param1,"category",this._questEngine.getCampaignName(this.var_129));
