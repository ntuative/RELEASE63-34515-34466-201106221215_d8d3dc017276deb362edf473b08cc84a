package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1533:int = 15;
      ...
      private var var_1230:QuestController;
      
      private var var_994:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1230 = new QuestController(this);
         this.var_994 = new AchievementController(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_419.events.removeEventListener(BadgeImageReadyEvent.const_203,this.var_994.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_419.events.addEventListener(BadgeImageReadyEvent.const_203,this.var_994.onBadgeImageReady);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Boolean = this._localization.hasKey(param1.getCampaignLocalizationKey() + ".searchtag");
         if(_loc2_)
         {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1230.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_994.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1230.questTracker.isVisible();
      }
