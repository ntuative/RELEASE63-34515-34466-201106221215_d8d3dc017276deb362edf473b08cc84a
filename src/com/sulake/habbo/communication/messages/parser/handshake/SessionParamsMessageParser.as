package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_3038:Boolean;
      
      protected var var_3036:String;
      
      protected var var_3037:Boolean;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_2248 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_2249 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
                  this.var_2252 = _loc5_ > 0;
                  break;
               case 3:
                  _loc5_ = param1.readInteger();
                  this.var_2250 = _loc5_ > 0;
                  break;
               case 4:
                  _loc5_ = param1.readInteger();
                  this.var_2251 = _loc5_ > 0;
                  break;
               case 5:
