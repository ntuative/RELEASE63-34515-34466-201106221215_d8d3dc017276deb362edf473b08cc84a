package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1296:Function;
      
      private var var_1297:Function;
      
      private var var_829:IAssetLibrary;
      
      private var var_1295:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_829.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_829.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         if(param1.type == AssetLoaderEvent.const_42)
         {
            ...
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_72));
            }
         }
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_606));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1297 != null)
            {
               this.var_1297(_loc4_);
               this.var_1297 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_829.loadAssetFromFile("hotel_view_banner_" + this.var_1295,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_747));
            }
