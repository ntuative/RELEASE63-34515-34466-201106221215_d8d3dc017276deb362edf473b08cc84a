package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_558:IKeyExchange;
      
      private var var_1034:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2614:PseudoRandom;
      ...
      private var var_253:HabboHotelView;
      
      private var var_1543:String = "";
      
      private const const_2070:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_658)
         {
            this.var_658 = param1;
            this.var_63.initConnection(HabboConnectionType.const_281);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_85,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_63 && this.var_152 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_152.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_253 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_152.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_152.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_253.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_152.getKey("use.sso.ticket") == "1";
         this.var_658 = this.var_152.getKey("sso.ticket",null);
         this.var_1959 = this.var_152.getKey("flash.client.url","");
         this.var_2615 = this.var_152.getKey("external.variables.txt","");
         if(this.var_253 == null)
         {
            this.var_253 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_63.mode = HabboConnectionType.const_98;
            if(this.var_658)
            {
               this.var_63.initConnection(HabboConnectionType.const_281);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_669,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_2009);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_63.mode = HabboConnectionType.const_98;
            if(this.var_152.keyExists("local.environment"))
            {
               this.var_63.mode = HabboConnectionType.const_1213;
            }
         }
         this.var_63.initConnection(HabboConnectionType.const_281);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_952);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2614 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_63.mode)
         {
            case HabboConnectionType.const_98:
               _loc6_ = "";
               _loc6_ = this.var_152.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_152.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1543 = _loc4_;
               this.var_253.loadBannerImage(_loc7_ + "?token=" + this.var_1543,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1213:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_2012:
               this.var_1034 = this.generateRandomHexString(30);
               this.var_558 = new DiffieHellman(new BigInteger(this.var_152.getKey("connection.development.prime"),16),new BigInteger(this.var_152.getKey("connection.development.generator"),16));
               this.var_558.init(this.var_1034);
               _loc8_ = this.var_558.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_558.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_558.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2614);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1959,this.var_2615));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2070,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_658 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_658);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_255);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2613)
         {
            _loc2_ = this.var_152.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2613 = true;
         var _loc2_:String = this.var_152.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_152.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_558 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_558.init(_loc14_);
            _loc15_ = this.var_558.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1034 = _loc14_;
            }
