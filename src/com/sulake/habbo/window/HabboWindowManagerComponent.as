package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1640:uint = 1;
      ...
      private var var_1614:IEventDispatcher;
      
      private var var_1337:Boolean = false;
      
      private var var_2049:ProfilerOutput;
      
      private var var_1616:ProfilerAgentTask;
      
      private var var_1615:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_226 = new Array(const_485);
         ...
         this.var_737 = this.var_226[const_1640];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2049)
            {
               this.var_2049 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2049.profiler = _loc3_;
            this.var_1616 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1616);
            this.var_1615 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1615);
            this.var_1337 = true;
         }
      }
      ...
      {
         return this.var_737.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_737.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_226[param1].getDesktopWindow().getChildAt(this.var_737.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_425.length > 0)
         {
            this.var_1614.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_485 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1614.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_425.length > 0)
         {
            WindowContext.var_425.flush();
         }
         MouseCursorControl.change();
         this.var_1614.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1933,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1884,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2022,param2.name + ": " + param2.toString());
            }
         }
      }
