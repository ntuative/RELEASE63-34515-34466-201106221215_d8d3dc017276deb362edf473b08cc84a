package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private var var_1028:Map;
      
      private var var_1275:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1941 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1941 = 15;
         }
         this.var_1940 = this._window.height;
         this.var_1534 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_608:
               ...
               _loc2_ = Number(this.var_1275) / Number(this.var_1028["time_fade_in"]);
               if(this.var_1275 > int(this.var_1028["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1089:
               ...
               if(this.var_1535 > int(this.var_1028["time_display"]) && !this.var_1942)
               {
                  this.startFadeOut();
               }
               break;
            case const_1090:
               ...
               _loc3_ = 1 - Number(this.var_1276) / Number(this.var_1028["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1276 > int(this.var_1028["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1941;
         if(this._window.height < this.var_1940)
         {
            this._window.height = this.var_1940;
         }
      }
      ...
      {
         this.var_1276 = 0;
         this._state = const_1090;
      }
      
      private function startDisplay() : void
      {
         this.var_1535 = 0;
         this._state = const_1089;
      }
