package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1650:String = "pixelbalance";
      
      private static const const_1648:String = "badges";
      
      private static const const_1653:String = "selectbadge";
      
      private static const const_1649:String = "inventory";
      
      private static const const_1652:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1655:String = "friendlist";
      
      private static const const_1654:String = "pet_inventory";
      
      private static const const_1651:String = "go_to_room";
      ...
      private var var_409:HabboNotificationViewManager;
      
      private var var_257:HabboAlertDialogManager;
      
      private var var_872:ParkBusDialogManager;
      
      private var var_2841:Boolean;
      
      private var var_1084:ClubGiftNotification;
      
      private var var_1087:ClubEndingNotification;
      
      private var var_1086:ClubPromoNotification;
      
      private var var_3071:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1956 = false;
         this.var_3071 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1085);
         }
         var _loc6_:Map = this.var_1085["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1085["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         var _loc1_:Array = this.var_1347.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_257 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_409)
         {
            this.var_409.topMarginIncrease = param1;
         }
      }
      ...
      {
         this.var_409 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1085["styles"],this.var_1085["view"]);
         ...
         registerUpdateReceiver(this.var_409,1);
         registerUpdateReceiver(this,2);
         this.var_419.events.addEventListener(BadgeImageReadyEvent.const_203,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_419.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1303,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1303,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1863,null);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_419.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_419.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_419.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1756,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1297)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2013,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1087 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1086 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_409.isSpaceAvailable() && this.var_1347.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_409.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1654:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_133);
               }
               break;
            case const_1652:
               break;
      ...
      {
         if(param1 != null && this.var_409 != null)
         {
            this.var_409.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_257 == null)
         {
            return;
         }
         this.var_257.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_257.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_257.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_257.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_257.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_872 == null)
         {
            this.var_872 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_872 != null)
         {
            this.var_872.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_992.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_198 || param2.type == WindowEvent.const_661)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1084 && this.var_1084.visible)
         {
            return;
         }
         this.var_1084 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
