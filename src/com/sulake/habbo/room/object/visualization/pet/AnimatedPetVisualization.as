package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1665:String = "head";
      
      private static const const_721:int = 1;
      
      private static const const_1134:int = 1000;
      
      private static const const_1662:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1662) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_412 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2871)
            {
               this.var_2871 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_317);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_146);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_317);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_146);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2118 = _loc3_.getNumber(RoomObjectVariableEnum.const_283) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_219);
            if(!isNaN(_loc8_))
            {
               this.var_2083 = _loc8_;
            }
            else
            {
               this.var_2083 = direction;
            }
            this.var_1628 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2476 = _loc3_.getNumber(RoomObjectVariableEnum.const_436);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_961);
            if(_loc9_ != this.var_2082)
            {
               this.var_2082 = _loc9_;
               this.var_2870 = this.var_2082.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_412 != null)
         {
            ...
            if(this.var_1628 > 0)
            {
               _loc2_ = param1 - this.var_1628;
               if(_loc2_ < const_1134)
               {
                  this.var_412.alpha = int(Math.sin(_loc2_ / const_1134 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_412.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_412.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_721;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2870);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_721)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_721))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2083);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1665)
            {
               this.var_1094[param1] = true;
            }
            else
            {
               this.var_1094[param1] = false;
            }
         }
