package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_713:PetVisualizationData = null;
      ...
      private const const_1657:int = 3;
      ...
      private var var_2070:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_579.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_579.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_713 = param1 as PetVisualizationData;
         createSprites(this.const_1657);
         var _loc2_:BitmapData = (this.var_713.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_412 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2118 = param1.getNumber(RoomObjectVariableEnum.const_283) > 0;
            this.var_1629 = param1.getString(RoomObjectVariableEnum.const_146);
            this.var_301 = param1.getString(RoomObjectVariableEnum.const_317);
            this.var_1658 = param1.getString(RoomObjectVariableEnum.const_1017);
            this.var_2070 = param1.getNumber(RoomObjectVariableEnum.const_219);
            this.var_1628 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2476 = param1.getNumber(RoomObjectVariableEnum.const_436);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_513 != param1.getUpdateID() || this.var_1873 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_2070;
            if(isNaN(this.var_2070))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2112 || param3)
            {
               this.var_2112 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_64.setDirectionAngle(AvatarSetType.const_41,_loc4_);
            }
            if(_loc5_ != this.var_2117 || param3)
            {
               this.var_2117 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_64.setDirectionAngle(AvatarSetType.const_58,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_579.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_713.getAvatar(this._figure,param1,this);
            if(_loc3_ != null)
            {
               this.var_579.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_714 = null;
         _loc2_ = getSprite(this.const_2083);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_1018 || this.var_1351 > 0 || this.var_2071;
         this.var_412.alpha = 0;
         if(this.var_1628 > 0)
         {
            _loc13_ = param2 - this.var_1628;
            if(_loc13_ < AvatarAction.const_1134)
            {
               this.var_412.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_412.setExperience(this.var_2476);
               this.var_1351 = this.const_2358;
            }
            else
            {
               this.var_1628 = 0;
            }
            _loc14_ = getSprite(this.const_2088);
            if(_loc14_ != null)
            {
               if(this.var_412.alpha > 0)
               {
                  _loc14_.asset = this.var_412.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_412.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1145);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1629 != null && this.var_1629 != "")
         {
            param1.appendAction(AvatarAction.const_326,this.var_1629);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1657;
