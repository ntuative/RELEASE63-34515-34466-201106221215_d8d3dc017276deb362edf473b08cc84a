package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2048:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2771:Number = NaN;
      
      private var var_2775:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1324:String = null;
      ...
      private var var_2772:Number = 0.0;
      ...
      private var var_2774:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1601 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1601;
            this.var_1601 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_675 != spriteCount)
         {
            createSprites(this.var_675);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2403;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_420:
               break;
            case LayerData.const_1403:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1196:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_513 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2771)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2775 = _loc3_.getNumber(RoomObjectVariableEnum.const_291);
            ...
            this.var_1324 = this.getAdClickUrl(_loc3_);
            if(this.var_1324 == null || this.var_1324.indexOf("http") != 0)
            {
               this.var_1324 = null;
            }
            this.var_2403 = this.var_1324 != null;
            this.var_2774 = _loc3_.getNumber(RoomObjectVariableEnum.const_832);
      ...
      {
         if(this.var_2773 != param2 || this.var_2772 != param1)
         {
            this.var_1073 = [];
            this.var_1072 = [];
            this.var_853 = [];
            ...
            this.var_2776 = this.getSize(param1);
      ...
      {
         this.var_675 = param1;
         this.var_1600 = this.var_675 - this.getAdditionalSpriteCount();
      }
      ...
      {
         if(this.var_851[param3] != null && !this.var_2037)
         {
      ...
      {
         if(this.var_855[param2] != null)
         {
            return this.var_855[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2774 * (param1 / 2));
      }
