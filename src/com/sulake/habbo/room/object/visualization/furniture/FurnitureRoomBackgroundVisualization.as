   ...
   public class FurnitureRoomBackgroundVisualization extends FurnitureRoomBrandingVisualization
   {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_841 != null)
         {
            ...
            _loc5_ = this.var_841[_loc4_];
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetX(param2,0) + var_1700;
            }
         }
         return super.getSpriteXOffset(param1,param2,param3) + var_1700;
      }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_841 != null)
         {
            ...
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetY(param2,0) + var_1699;
            }
         }
         return super.getSpriteYOffset(param1,param2,param3) + var_1699;
      }
