package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_991:SizeData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_322 != null)
         {
            ...
            {
               _loc1_ = this.var_322.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_322.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_322.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_991 = this.var_322.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_991 = null;
