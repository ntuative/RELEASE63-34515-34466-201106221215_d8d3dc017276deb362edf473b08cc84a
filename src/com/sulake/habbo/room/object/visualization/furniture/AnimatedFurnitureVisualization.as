package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_128:AnimationStateData;
      
      private var var_1965:int = 0;
      
      private var var_468:Number = 0;
      ...
      {
         super();
         this.var_128 = new AnimationStateData();
      }
      ...
      {
         return this.var_128.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1359 && this._animationData.hasAnimation(this.var_468,_loc2_))
         {
            return _loc2_;
         }
         return const_1359;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_741);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_741);
                     if(_loc5_ > this.var_1965)
                     {
                        this.var_1965 = _loc5_;
                        this.setAnimation(this._state);
                     }
                  }
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_818);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_468,_loc4_);
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_128,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_468,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_468,_loc6_))
                  {
      ...
      {
         return this.var_128.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_128 != null)
         {
            this.var_128.setLayerCount(this.var_675);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_468 = param1;
            this.var_675 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_128.animationOver || this.var_1037)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_128,param1);
            if(this.var_128.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_128.animationId) || AnimationData.isTransitionToAnimation(this.var_128.animationId))
               {
                  this.setAnimation(this.var_128.animationAfterTransitionId);
                  this.var_128.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_1037)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_675 - 1;
         var _loc8_:int = this.var_675 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_1037)
            {
               ...
               if(this.var_1037 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1242)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_520)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_128.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_128.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
