package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_289:IRoomObjectSprite;
      ...
      private var var_1319:Number = 1.0;
      
      private var var_676:BitmapData;
      
      private var var_849:ColorTransform;
      
      private var var_1591:ColorTransform;
      ...
      {
         super();
         this.var_1320 = new Dictionary();
         this._visualization = param1;
         this.var_849 = new ColorTransform();
         this.var_849.alphaMultiplier = 1;
         this.var_1591 = new ColorTransform();
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1320)
         {
            _loc1_.dispose();
         }
         this.var_1320 = null;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_112 = this.var_1320[param1];
         this.var_1069 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_2023 >= 0)
         {
            this.var_289 = this._visualization.getSprite(this.var_2023);
            if(this.var_289 && this.var_289.asset)
            {
               if(this.var_289.width <= 1 || this.var_289.height <= 1)
               {
                  return;
               }
               if(this.var_98 == null)
               {
                  this.var_98 = this.var_289.asset.clone();
                  if(this.var_849.alphaMultiplier != 1)
                  {
                     this.var_676 = new BitmapData(this.var_98.width,this.var_98.height,true,4278190080);
                  }
               }
               this.var_2542 = -this.var_289.offsetX;
               this.var_2543 = -this.var_289.offsetY;
               this.var_289.asset = this.var_98;
            }
            if(this.var_98)
            {
            ...
            if(this.var_676)
            {
               this.var_676.fillRect(this.var_676.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_112.y * this.var_1319;
         }
         return 0;
      }
      ...
      {
         if(!this.var_112 || !this.var_289)
         {
            return;
         }
         if(this.var_98 && this.var_289.asset != this.var_98)
         {
            this.var_289.asset = this.var_98;
         }
         if(this.var_1069)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1069 && this.var_112.hasIgnited)
         {
            this.var_1069 = true;
         }
         _loc8_ = this.var_1198 * this.var_1319;
         this.var_112.update();
         if(this.var_1069)
         {
            if(this.var_112.roomObjectSpriteId >= 0)
            ...
            {
               this.var_98.draw(this.var_676,this.var_2024,this.var_849,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_112.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2542 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1319;
               _loc4_ = this.var_2543 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1319;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1591.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_98.draw(_loc7_,this._translationMatrix,this.var_1591,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
