package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1583:int = 0;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1700 = _loc4_.getNumber(RoomObjectVariableEnum.const_614);
                  this.var_1699 = _loc4_.getNumber(RoomObjectVariableEnum.const_601);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_624);
               }
            }
         }
         if(!this.var_1417)
         {
            this.var_1417 = this.checkIfImageReady();
            if(this.var_1417)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_662);
                     if(_loc4_ == 1)
                     {
