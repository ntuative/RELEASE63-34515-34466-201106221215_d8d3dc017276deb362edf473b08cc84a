package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_915:IGraphicAssetCollection;
      
      private var var_1939:XMLList;
      
      private var _offsetX:int;
      
      private var var_1198:int;
      
      private var var_2848:Vector3d;
      ...
      {
         if(param1 != this.var_1089)
         {
            this.var_1089 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1627 = this.var_46.getValue(this.var_1089);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2848 = new Vector3d(-0.5,0.5,0);
         this.var_1088 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2848);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_1089);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_2067 = RoomObjectVariableEnum.const_1250;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_2067 = RoomObjectVariableEnum.const_1221;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_1089);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2847 && param3 == this.var_2846)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_2067);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_532;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = this.var_915.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_489.indexOf(_loc10_) >= 0 && this.var_1088)
            {
               param1 = this.var_489.indexOf(_loc10_);
               if(this.var_691[param1] != "")
               {
                  _loc9_ = this.var_915.getAsset(this.var_691[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_1088 = true;
         var _loc3_:int = this.var_489.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_489.push(param1);
