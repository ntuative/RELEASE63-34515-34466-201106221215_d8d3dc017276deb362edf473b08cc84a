package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1982:int = 0;
      ...
      private var var_1325:Vector3d = null;
      ...
      private var var_2102:Boolean = true;
      ...
      private var var_1101:IPlaneRasterizer = null;
      ...
      private var var_2899:Number = 0;
      
      private var var_225:Map = null;
      
      private var var_495:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_334.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_335,this.var_334);
         ...
         this.var_2901 = param9;
         this.var_2900 = param10;
         this.var_2902 = param11;
         this.var_2899 = param12;
      ...
      {
         return this._isVisible && this.var_889;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1101.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_495;
         if(_loc3_ == null)
         {
         ...
         if(this.var_889 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_416))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_334.length * param1.scale;
            ...
            if(this.var_1101 != null)
            {
               _loc3_ = this.var_1101.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2102,this.var_2901,this.var_2900,this.var_2902,this.var_2899,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1873 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_889)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1650.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1650[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1325);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_181.z - originZ,this.var_132.z - originZ,this.var_99.z - originZ,this.var_133.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2784 = relativeDepth;
            this._isVisible = true;
            this.var_1873 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            if(this._bitmapData == null || this.var_210 != this._bitmapData.width || this._height != this._bitmapData.height)
            {
               if(this._bitmapData != null)
               {
                  this._bitmapData.dispose();
                  this._bitmapData = null;
                  if(this.var_210 < 1 || this._height < 1)
                  {
                     return true;
                  }
               }
               else if(this.var_210 < 1 || this._height < 1)
               {
                  return false;
               }
               try
               {
                  this._bitmapData = new BitmapData(this.var_210,this._height,true,16777215);
               }
               catch(e:Error)
               {
                  _bitmapData = null;
            ...
            Randomizer.setSeed(this.var_2898);
      ...
      {
         this.var_181.assign(param1.getScreenPosition(this.var_103));
         this.var_132.assign(param1.getScreenPosition(Vector3d.sum(this.var_103,this.var_334)));
         this.var_99.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_103,this.var_335),this.var_334)));
         this.var_133.assign(param1.getScreenPosition(Vector3d.sum(this.var_103,this.var_335)));
         this._offset = param1.getScreenPoint(this.var_1325);
         ...
         var _loc2_:Number = Math.min(this.var_181.x,this.var_132.x,this.var_99.x,this.var_133.x);
         var _loc3_:Number = Math.max(this.var_181.x,this.var_132.x,this.var_99.x,this.var_133.x);
         var _loc4_:Number = Math.min(this.var_181.y,this.var_132.y,this.var_99.y,this.var_133.y);
         var _loc5_:Number = Math.max(this.var_181.y,this.var_132.y,this.var_99.y,this.var_133.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_181 == null || this.var_132 == null || this.var_99 == null || this.var_133 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1102)
         {
            ...
            {
               _loc4_ = this.var_299[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1102)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_417.length)
            {
               _loc5_ = this.var_417[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_299.length == this.var_1103.length)
         {
            while(_loc1_ < this.var_299.length)
            {
               _loc4_ = this.var_299[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1103.length)
                  {
                     _loc7_ = this.var_1103[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_417.length > this.var_1649.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1102 || this.var_299.length == 0 && this.var_417.length == 0 && !this.var_416 || this.var_766 == null)
         {
            return;
         }
         ...
         if(this.var_416)
         {
            ...
            while(_loc5_ < this.var_299.length)
            {
               _loc3_ = this.var_299[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_335.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_334.length;
                  _loc12_ = _loc3_.type;
                  this.var_766.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1103.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_417.length)
            {
               _loc4_ = this.var_417[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_335.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_334.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_335.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_334.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1649.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_416 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_260 != null && (this.var_260.width != param1.width || this.var_260.height != param1.height))
         {
            this.var_260.dispose();
            this.var_260 = null;
         }
         if(this.var_260 == null)
         {
            this.var_260 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_260.copyChannel(param1,param1.rect,const_723,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_260.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_260,this.var_260.rect,const_723,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
