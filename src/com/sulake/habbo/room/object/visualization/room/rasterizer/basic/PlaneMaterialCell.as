package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_703:PlaneTexture;
      ...
      public function PlaneMaterialCell(param1:PlaneTexture, param2:Array = null, param3:Array = null, param4:int = 0)
      {
         ...
         if(param2 != null && param2.length > 0 && param4 > 0)
         {
            ...
            while(_loc5_ < param2.length)
            {
               ...
               if(_loc6_ != null)
               {
                  this.var_1095.push(_loc6_);
               }
               _loc5_++;
            }
            if(this.var_1095.length > 0)
            {
               if(param3 != null)
               {
                  _loc5_ = 0;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_703 != null)
         {
            _loc2_ = this.var_703.getBitmap(param1);
            if(_loc2_ != null)
            {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  while(_loc6_ < _loc3_)
                  {
                     ...
                     _loc8_ = this.var_1095[_loc6_ % this.var_1095.length] as IGraphicAsset;
