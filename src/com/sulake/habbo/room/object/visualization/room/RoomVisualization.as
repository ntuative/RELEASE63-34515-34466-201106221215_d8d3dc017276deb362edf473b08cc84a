package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1847:int = 16777215;
      
      public static const const_1753:int = 13421772;
      ...
      private static const const_1073:int = 10066329;
      
      public static const const_1871:int = 16777215;
      
      public static const const_1950:int = 13421772;
      
      public static const const_1920:int = 10066329;
      ...
      private var var_541:RoomPlaneBitmapMaskParser = null;
      
      private var var_1452:String = null;
      
      private var _floorType:String = null;
      
      private var var_1453:String = null;
      
      private var var_946:Number = NaN;
      
      private var var_1446:Number = NaN;
      
      private var var_2503:Number = NaN;
      
      private var var_1874:String = null;
      
      private var var_1236:uint = 16777215;
      
      private var var_2499:int = 255;
      ...
      private const const_2345:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_541 = new RoomPlaneBitmapMaskParser();
         this.var_323["null"] = false;
         this.var_323["null"] = true;
         this.var_323["null"] = true;
         this.var_323["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_148.length)
            {
               _loc2_ = this.var_148[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_148.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_148[_loc2_] as RoomPlane;
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_116)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_946))
         {
            this._planeParser.floorThicknessMultiplier = this.var_946;
         }
         if(!isNaN(this.var_1446))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1446;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_825);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1310);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_421)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1907)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_76,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_421)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2345 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_383.length)
            {
               _loc11_ = this.var_633[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_383[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1875)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2498 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2500 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2499 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1873)
         {
            this.var_1873 = param1.updateId;
            this.var_800 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1604 || _loc3_.y != this.var_2502 || _loc3_.z != this.var_2501 || param1.scale != this.var_1872))
            {
               this.var_1604 = _loc3_.x;
               this.var_2502 = _loc3_.y;
               this.var_2501 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1379);
            if(_loc3_ != this.var_1874)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1874 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_835));
            if(_loc4_ != this.var_1236)
            {
               this.var_1236 = _loc4_;
               this.var_2498 = this.var_1236 & 255;
               this.var_2500 = this.var_1236 >> 8 & 255;
               this.var_2499 = this.var_1236 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1397));
            if(_loc5_ != this.var_1875)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_234);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_850));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_940));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_755));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1188);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1223);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_946 || _loc3_ != this.var_1446))
            {
               this.var_946 = _loc2_;
               this.var_1446 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_145 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1392);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2503)
            {
               this.var_2503 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_148.length)
         {
            _loc5_ = this.var_148[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_116 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_323["null"] || param2 != this.var_323["null"] || param3 != this.var_323["null"])
         {
            this.var_323["null"] = param1;
            this.var_323["null"] = param2;
            this.var_323["null"] = param3;
            this.var_383 = [];
            this.var_633 = [];
         }
      }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_116)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_323[_loc12_.type]))
                  {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_541.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_148.length)
         {
            _loc3_ = this.var_148[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_541.maskCount)
         {
            _loc10_ = this.var_541.getMaskType(_loc8_);
            _loc11_ = this.var_541.getMaskLocation(_loc8_);
            _loc12_ = this.var_541.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_148.length)
               {
                  _loc3_ = this.var_148[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_247)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_148[_loc18_] as RoomPlane;
