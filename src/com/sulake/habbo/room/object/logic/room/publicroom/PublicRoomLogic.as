package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_215,RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_348];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_417,"");
         _loc2_.setString(RoomObjectVariableEnum.const_1024,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_510,Number(false));
         this.var_842 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1644 > 0 && param1 > this.var_1644)
         {
            this.adDelayTimeout();
            this.var_1644 = 0;
         }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1284:
                  _loc2_.setString(RoomObjectVariableEnum.const_417,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_1024,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_510,Number(true));
                  this.var_1644 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1191);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_510,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_532)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_1024);
