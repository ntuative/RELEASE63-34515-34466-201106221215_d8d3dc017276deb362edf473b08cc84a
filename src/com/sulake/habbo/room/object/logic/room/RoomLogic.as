package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1462:uint = 16777215;
      
      private var var_1769:int = 255;
      
      private var var_1184:uint = 16777215;
      
      private var var_1768:int = 255;
      
      private var var_1183:int = 0;
      
      private var var_1766:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_605,RoomObjectMouseEvent.const_173];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_825,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_835,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_850,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_940,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_755,1);
         }
      }
         ...
         if(this.var_1461)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_825,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1392,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1183)
         {
            ...
            if(_loc2_ - this.var_1183 >= this.var_1766)
            {
               _loc3_ = this.var_1184;
               _loc4_ = this.var_1768;
               this.var_1183 = 0;
            }
            else
            {
               _loc7_ = this.var_1462 >> 16 & 255;
               _loc8_ = this.var_1462 >> 8 & 255;
               _loc9_ = this.var_1462 & 255;
               _loc10_ = this.var_1184 >> 16 & 255;
               _loc11_ = this.var_1184 >> 8 & 255;
               _loc12_ = this.var_1184 & 255;
               _loc13_ = (_loc2_ - this.var_1183) / this.var_1766;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1769 + (this.var_1768 - this.var_1769) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_835,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_826:
            ...
            case RoomObjectRoomUpdateMessage.const_864:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_794:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_583:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_247)
               {
                  _loc5_ = "null";
               }
               this.var_541.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_917:
               _loc4_ = this.var_541.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_541.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1379,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1190:
               param2.setNumber(RoomObjectVariableEnum.const_850,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1327:
               param2.setNumber(RoomObjectVariableEnum.const_940,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_755,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_685:
               param2.setNumber(RoomObjectVariableEnum.const_1188,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1300:
               param2.setNumber(RoomObjectVariableEnum.const_1223,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_154:
               ...
               this.var_1461 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_153:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1397,int(param1.bgOnly));
         this.var_1462 = this._color;
         this.var_1769 = this.var_1767;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1962,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1975,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1830,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_262 || _loc12_ == RoomPlaneData.const_421)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
