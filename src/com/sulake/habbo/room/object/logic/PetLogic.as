package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_173,RoomObjectMoveEvent.const_439];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2810)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_219,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1610 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_283,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_436,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1893,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_961,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_219,_loc3_ + this.var_1075);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2040;
            _loc2_.setNumber(RoomObjectVariableEnum.const_317,this.var_2040);
            _loc2_.setNumber(RoomObjectVariableEnum.const_146,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2039;
            _loc2_.setNumber(RoomObjectVariableEnum.const_146,this.var_2039);
         }
         else
         {
            this.var_1075 += 45;
