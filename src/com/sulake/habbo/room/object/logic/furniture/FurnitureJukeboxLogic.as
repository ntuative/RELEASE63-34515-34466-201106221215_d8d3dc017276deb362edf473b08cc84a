package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_596,RoomObjectFurnitureActionEvent.const_582,RoomObjectFurnitureActionEvent.const_526,RoomObjectFurnitureActionEvent.const_640,RoomObjectWidgetRequestEvent.const_160];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_965) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_424,RoomWidgetInfostandExtraParamEnum.const_668);
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_582,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
      ...
      private function requestDispose() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_526,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
   }
}
