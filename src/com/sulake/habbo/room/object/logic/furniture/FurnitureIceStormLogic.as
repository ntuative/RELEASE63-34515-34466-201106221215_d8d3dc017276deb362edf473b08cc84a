package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2983:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_2179 = _loc2_;
            this.var_2983 = param1.extra;
            this.var_1390 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1390 > 0 && param1 >= this.var_1390)
         {
            this.var_1390 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2179,String(this.var_2179),this.var_2983);
