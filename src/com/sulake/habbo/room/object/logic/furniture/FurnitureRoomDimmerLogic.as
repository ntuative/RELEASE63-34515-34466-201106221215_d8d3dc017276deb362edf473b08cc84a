package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_141,RoomObjectWidgetRequestEvent.const_110,RoomObjectDimmerStateUpdateEvent.const_68];
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_141,_loc1_,_loc2_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1721)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_110,_loc1_,_loc2_);
