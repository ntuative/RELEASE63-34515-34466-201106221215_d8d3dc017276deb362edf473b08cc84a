package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_477:int = 8;
      
      private static const const_1083:Number = 0.0625;
      ...
      private var var_1255:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_324,RoomObjectRoomAdEvent.const_348,RoomObjectRoomAdEvent.const_558,RoomObjectStateChangeEvent.const_67,RoomObjectMouseEvent.const_173,RoomObjectRoomAdEvent.const_215,RoomObjectMouseEvent.const_493];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         this.var_2542 = this.var_565 / 2;
         this.var_2543 = this.var_669 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_1904 = Number(_loc3_);
         }
         else
         {
            this.var_1904 = this.var_1516 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_257,this.var_565,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_361,this.var_669,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_603,this.var_1516,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_2007,this.var_2542,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1886,this.var_2543,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_764,this.var_1904,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_852,this.var_294,true);
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               if(eventDispatcher != null)
               {
                  _loc4_ = object.getId();
                  _loc5_ = object.getType();
                  _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_493,param1.eventId,_loc4_,_loc5_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
                  eventDispatcher.dispatchEvent(_loc6_);
               }
         }
      }
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_558,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.setString(RoomObjectVariableEnum.const_353,String(param1.extra));
            }
            _loc2_.setNumber(RoomObjectVariableEnum.const_741,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1324,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1905 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_388 = 1;
                  this.var_1255 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1905 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_388 > 0)
         {
            this.var_1011.x = 0;
            this.var_1011.y = 0;
            if(this.var_388 <= const_477 / 2)
            {
               this.var_1011.z = const_1083 * this.var_388;
            }
            else if(this.var_388 <= const_477)
            {
               if(this.var_1255)
               {
                  super.processUpdateMessage(this.var_1255);
                  this.var_1255 = null;
               }
               this.var_1011.z = const_1083 * (const_477 - this.var_388);
            }
