package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_685:Number = 0.25;
      
      private static const const_1300:Number = 0.25;
      
      public static const const_71:int = -101;
      
      public static const const_132:int = -100;
      ...
      private var var_1446:Number = 1.0;
      
      private var var_946:Number = 1.0;
      
      private var var_993:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_616.push(_loc6_);
            _loc3_++;
         }
         this.var_210 = param1;
         this._height = param2;
         this._minX = this.var_210;
         this.var_440 = -1;
         this.var_438 = this._height;
         this.var_439 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_210 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this._minX || param1 == this.var_440)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_438;
               ...
               if(param2 == this.var_438 || param2 == this.var_439)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_210)
            {
               this._tileMatrixOriginal[_loc2_][_loc3_] = this.var_117[_loc2_][_loc3_];
               _loc3_++;
            }
            _loc2_++;
         }
         var _loc4_:Point = findEntranceTile(this.var_117);
         _loc2_ = 0;
         while(_loc2_ < this._height)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_210)
            {
               if(this.var_616[_loc2_][_loc3_])
               {
                  this.var_117[_loc2_][_loc3_] = const_132;
               }
               _loc3_++;
            }
            _loc2_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         this.var_993 = getFloorHeight(this.var_117);
         if(!param2)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_117.length)
         {
            _loc4_ = this.var_117[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_132)
            {
               _loc9_--;
               break;
            }
         ...
         if(_loc22_)
         {
            ...
            while(_loc2_ < _loc26_)
            {
               if(!_loc20_[_loc2_])
               {
                  ...
                  {
                     if(this.getTileHeightInternal(_loc29_.x + _loc3_ * _loc30_.x - _loc31_.x,_loc29_.y + _loc3_ * _loc30_.y - _loc31_.y) == const_132)
                     {
                        _loc20_[_loc2_] = true;
                        break;
                     }
      ...
      private function extractTopWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y) > const_132)
            {
               return new Point(param1.x + _loc2_ - 1,param1.y);
            }
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y + 1) <= const_132)
            {
      ...
      private function extractRightWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x,param1.y + _loc2_) > const_132)
            {
               return new Point(param1.x,param1.y + (_loc2_ - 1));
            }
            if(this.getTileHeightInternal(param1.x - 1,param1.y + _loc2_) <= const_132)
            {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_262,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_421,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1300 * this.var_1446;
         var _loc9_:Number = const_685 * this.var_946;
         ...
         this.addPlane(RoomPlaneData.const_262,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_262,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_262,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_262,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function extractFloorPlane(param1:Array, param2:Boolean) : Boolean
      {
         ...
         var _loc16_:Number = _loc12_ - _loc10_;
         var _loc17_:int = 1;
         var _loc18_:int = 1;
         var _loc19_:int = 1;
         var _loc20_:int = 1;
         ...
         var _loc29_:int = 0;
         _loc3_ = _loc9_ - 1;
         while(_loc3_ < _loc11_ + 1)
         {
            if(_loc3_ >= _loc9_ && _loc3_ < _loc11_)
            {
               if(_loc17_)
               {
                  _loc29_ = Math.abs(this.getTileHeightInternal(_loc3_,_loc10_ - 1) - this.getTileHeightInternal(_loc3_,_loc10_));
                  if(_loc29_ != 1)
                  {
                     _loc17_ = 0;
                  }
                  ...
                  {
                     _loc17_ = this.getTileHeightInternal(_loc3_,_loc10_ - 1) - this.getTileHeightInternal(_loc3_,_loc10_);
                  }
               }
               if(_loc18_)
               {
                  _loc29_ = Math.abs(this.getTileHeightInternal(_loc3_,_loc12_) - this.getTileHeightInternal(_loc3_,_loc12_ - 1));
                  if(_loc29_ != 1)
                  {
                     _loc18_ = 0;
                  }
                  ...
                  {
                     _loc18_ = this.getTileHeightInternal(_loc3_,_loc12_) - this.getTileHeightInternal(_loc3_,_loc12_ - 1);
                  }
               }
            ...
            {
               _loc29_ = Math.abs(this.getTileHeightOriginal(_loc3_,_loc10_ - 1) - this.getTileHeightOriginal(_loc3_,_loc10_));
               if(_loc29_ == 1)
               {
                  _loc21_ = 1;
               }
               _loc29_ = Math.abs(this.getTileHeightOriginal(_loc3_,_loc12_) - this.getTileHeightOriginal(_loc3_,_loc12_ - 1));
               if(_loc29_ == 1)
               {
                  _loc22_ = 1;
               }
         ...
         {
            if(_loc3_ >= _loc10_ && _loc3_ < _loc12_)
            {
               if(_loc19_)
               {
                  _loc29_ = Math.abs(this.getTileHeightInternal(_loc9_ - 1,_loc3_) - this.getTileHeightInternal(_loc9_,_loc3_));
                  if(_loc29_ != 1)
                  {
                     _loc19_ = 0;
                  }
                  ...
                  {
                     _loc19_ = this.getTileHeightInternal(_loc9_ - 1,_loc3_) - this.getTileHeightInternal(_loc9_,_loc3_);
                  }
               }
               if(_loc20_)
               {
                  _loc29_ = Math.abs(this.getTileHeightInternal(_loc11_,_loc3_) - this.getTileHeightInternal(_loc11_ - 1,_loc3_));
                  if(_loc29_ != 1)
                  {
                     _loc20_ = 0;
                  }
                  ...
                  {
                     _loc20_ = this.getTileHeightInternal(_loc11_,_loc3_) - this.getTileHeightInternal(_loc11_ - 1,_loc3_);
                  }
               }
            ...
            {
               _loc29_ = Math.abs(this.getTileHeightOriginal(_loc9_ - 1,_loc3_) - this.getTileHeightOriginal(_loc9_,_loc3_));
               if(_loc29_ == 1)
               {
                  _loc23_ = 1;
               }
               _loc29_ = Math.abs(this.getTileHeightOriginal(_loc11_,_loc3_) - this.getTileHeightOriginal(_loc11_ - 1,_loc3_));
               if(_loc29_ == 1)
               {
                  _loc24_ = 1;
               }
         ...
         var _loc30_:Number = _loc13_;
         var _loc31_:Number = _loc9_ - 0.5;
         var _loc32_:Number = _loc10_ - 0.5;
         var _loc33_:int = 1;
         var _loc34_:int = 1;
         var _loc35_:int = 1;
         var _loc36_:int = 1;
         if(_loc17_)
         {
            ...
            this.addFloor(new Vector3d(_loc31_ + _loc15_,_loc32_ + 0.34,_loc30_ + _loc17_ / 4 * 2),new Vector3d(-_loc15_,0,0),new Vector3d(0,-0.34,0),_loc28_ > 0,_loc27_ > 0,_loc36_ > 0,_loc35_ > 0,0,0,0,0,false,true);
            this.addFloor(new Vector3d(_loc31_ + _loc15_,_loc32_ + 0.67,_loc30_ + _loc17_ / 4),new Vector3d(-_loc15_,0,0),new Vector3d(0,-0.33,0),_loc28_ > 0,_loc27_ > 0,_loc36_ > 0,_loc35_ > 0,0,0,0,0,false,true);
         }
         if(_loc18_)
         {
            if(_loc18_ < 0)
            ...
            this.addFloor(new Vector3d(_loc31_ + _loc15_,_loc32_ + _loc16_,_loc30_ + _loc18_ / 4),new Vector3d(-_loc15_,0,0),new Vector3d(0,-0.33,0),_loc28_ > 0,_loc27_ > 0,_loc36_ > 0,_loc35_ > 0,0,0,0,0,false,true);
         }
         if(_loc19_)
         {
            if(_loc19_ > 0)
            ...
            this.addFloor(new Vector3d(_loc31_ + 0.34,_loc32_ + _loc16_,_loc30_ + _loc19_ / 4 * 2),new Vector3d(-0.34,0,0),new Vector3d(0,-_loc16_,0),_loc34_ > 0,_loc33_ > 0,_loc26_ > 0,_loc25_ > 0,0,0,0,0,true,false);
            this.addFloor(new Vector3d(_loc31_ + 0.67,_loc32_ + _loc16_,_loc30_ + _loc19_ / 4),new Vector3d(-0.33,0,0),new Vector3d(0,-_loc16_,0),_loc34_ > 0,_loc33_ > 0,_loc26_ > 0,_loc25_ > 0,0,0,0,0,true,false);
         }
         if(_loc20_)
         {
            if(_loc20_ < 0)
            ...
            this.addFloor(new Vector3d(_loc31_ + _loc15_,_loc32_ + _loc16_,_loc30_ + _loc20_ / 4),new Vector3d(-0.33,0,0),new Vector3d(0,-_loc16_,0),_loc34_ > 0,_loc33_ > 0,_loc26_ > 0,_loc25_ > 0,0,0,0,0,true,false);
         }
         _loc4_ = _loc10_;
         ...
         this.addFloor(new Vector3d(_loc31_ + _loc15_,_loc32_ + _loc16_,_loc30_),new Vector3d(-_loc15_,0,0),new Vector3d(0,-_loc16_,0),_loc28_ > 0,_loc27_ > 0,_loc26_ > 0,_loc25_ > 0,_loc37_,_loc38_,_loc39_,_loc40_,false,false);
         return true;
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_301,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_685 * this.var_946;
            _loc19_ = _loc18_;
            if(this.var_946 > 1)
            {
               _loc19_ = const_685;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_301,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_301,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_301,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_301,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_210}" height="{this._height}" wallHeight="{this.var_1447}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc7_ = <tileRow/>;
         ...
         {
            _loc12_ = this.var_313.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_313.getKey(_loc4_);
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_148[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1399;
         }
         var _loc2_:RoomPlaneData = this.var_148[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_148[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_313.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_313.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc4_ < this.var_313.length)
         {
            _loc5_ = this.var_313.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
               ...
               _loc7_ = _loc7_ >= this.var_210 ? int(this.var_210 - 1) : int(_loc7_);
