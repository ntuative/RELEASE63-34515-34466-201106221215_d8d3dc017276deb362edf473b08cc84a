package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_2062:int = 0;
      
      private static const const_1088:int = 1;
      
      private static const name_5:int = 2;
      
      private static const const_481:String = "place_holder";
      
      private static const const_700:String = "wall_place_holder";
      
      private static const const_698:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_481;
      
      private static const const_699:String = "room";
      ...
      private var var_1527:IEventDispatcher = null;
      ...
      private var var_1021:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1022:Map = null;
      
      private var var_220:PublicRoomData = null;
      
      private var var_1526:Map = null;
      ...
      {
         this.var_391 = new Dictionary();
         this._wallItems = new Dictionary();
         this._pets = new Dictionary();
         this.var_2590 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2588 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1088)
         {
            return;
         }
         this.var_1527 = param1;
         this.var_2586 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2589 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1021.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_419.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_815.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_464.add(_loc3_,_loc4_);
               if(this.var_391[_loc7_] == null)
               {
                  this.var_391[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_645.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2587)
         {
            ...
            {
               this.var_1527.dispatchEvent(new Event(const_916));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_220 != null && (this.var_220.type == param1 || this.var_220.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_84;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_84;
         ...
         {
            return RoomObjectCategoryEnum.const_381;
         }
         return RoomObjectCategoryEnum.const_165;
      }
      ...
      {
         return [const_481,const_700,const_698,const_699,TILE_CURSOR,const_1087];
      }
      ...
      {
         var _loc3_:String = this.var_645.getValue(param1) as String;
      ...
      {
         return this.var_1021.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1022[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_645.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_815.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_220 != null && this.var_220.hasWorldType(const_389 + param1))
         {
            return this.var_220.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_268 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_391[_loc4_] == null)
                     {
                        this.var_391[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_448,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1526.getValue(param1) != null)
         {
            this.var_220 = this.var_1526.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_862,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2590.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1993);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2588.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1022.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1526.add(param1,_loc4_);
         this.var_220 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_816.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_816.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_816.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_556.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_389 + param1) == RoomObjectCategoryEnum.const_84)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_220.getWorldHeightScale(const_389 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_220 != null)
         {
            return this.var_220.getWorldScale(const_389 + param1);
         }
         return 32;
      }
