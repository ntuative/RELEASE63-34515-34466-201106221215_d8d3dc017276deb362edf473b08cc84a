package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1610:int = 1000;
      ...
      private var var_1566:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_470 = [];
         this.var_469 = [];
         this.var_663 = new Timer(const_1609,1);
         this.var_663.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2689 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_140,this.onObjectPlaced);
               }
            ...
            {
               this.var_663.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_663.stop();
               this.var_663 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1566 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1566;
            }
            else
            {
         ...
         this.var_28.setInventoryCategoryInit(InventoryCategory.const_78);
         ...
         for each(_loc6_ in param2)
         {
            if(_loc9_.indexOf(_loc6_.stripId) > -1)
            {
               ...
               this.var_28.events.dispatchEvent(_loc19_);
            }
         }
      }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_323)
         {
         ...
         if(this.var_835 == null)
         {
            this.var_835 = this._windowManager.buildFromXML(this.var_2689) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_835.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_835.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,this._roomEngine,_loc9_.clone(),this.var_28.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      {
         if(param1 == InventoryCategory.const_78 && this.var_28.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               case const_39:
                  this.var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_45:
                  this.var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_260:
                  this.var_28.toggleInventoryPage(InventoryCategory.const_133);
            }
         }
      }
      ...
      {
         this.var_2688 = getTimer();
         this.switchCategory(const_260);
      }
      ...
      {
         this.var_28.checkCategoryInitilization(InventoryCategory.const_419);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc2_:TradingModel = this.var_28.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = this.var_28.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_664.add(const_39,new Array());
         this.var_664.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_260)
            {
               if(!this.furniIsMostLikelyPetFood())
               {
                  this.var_28.petsModel.switchToFurnitureCategory(_loc6_,true);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2688 + const_1610;
      }
      ...
      {
         return this.var_28.getSubCategoryViewId() == InventorySubCategory.const_346;
      }
      
      public function canUserOfferToTrade() : Boolean
      {
         return this.var_28.canUserOfferToTrade();
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_366 || _loc3_.category == FurniCategory.const_323 || _loc3_.category == FurniCategory.const_333)
         {
            if(param1)
            {
               return false;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(_loc3_)
         {
            this.var_1565 = param1.ref;
            if(!this.var_28.recyclerModel.running)
            {
               this.requestClose();
            }
            this.var_1381 = true;
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = this.var_28.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = this.var_28.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this.var_664.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_664.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_888)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      {
         if(!this.var_28 || !this.var_28.roomSession)
         {
            return false;
         }
         return this.var_28.roomSession.isPrivateRoom;
      }
      
      public function isMainViewActive() : Boolean
      {
         return this.var_28.isMainViewActive;
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_399:
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_39:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_399));
                  this.var_470 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
         if(_loc3_)
         {
            this.var_28.updateUnseenItemCounts();
            for each(_loc4_ in _loc3_)
            {
