package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2337:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_419 = param5;
         this.var_419.events.addEventListener(BadgeImageReadyEvent.const_203,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_419.events.removeEventListener(BadgeImageReadyEvent.const_203,this.onBadgeImageReady);
            this.var_419 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1200.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_623.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_419.getBadgeImage(param1);
            if(_loc10_)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_356);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_646);
         ...
         var _loc3_:Array = this.getBadges(const_356);
      ...
      {
         return this.getItemInIndex(param1,const_356);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_646);
      }
      ...
      {
         if(param1 == InventoryCategory.const_245 && this.var_28.isVisible)
         {
            this.var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_623.indexOf(_loc2_) == -1)
            {
               this.var_623.push(_loc2_);
            }
         }
      }
      ...
      {
         return this.var_623.length;
      }
      
      public function resetUnseenItems() : void
      {
         var _loc2_:* = null;
         if(!this.var_28.isMainViewActive)
         {
            return;
         }
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_623 && this.var_623.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1247));
            this.var_623 = [];
