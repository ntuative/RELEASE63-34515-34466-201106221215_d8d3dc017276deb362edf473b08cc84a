package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsModel implements IInventoryModel
   {
      ...
      {
         this.var_28.communication.getHabboMainConnection(null).send(new AvatarEffectActivatedComposer(param1));
      }
      ...
      public function useEffect(param1:int) : void
      {
         ...
         {
            _loc2_.isInUse = true;
            this.var_28.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(param1));
            this.refreshViews();
         }
      }
      ...
      public function stopUsingEffect(param1:int, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.isInUse == true)
            {
               ...
               if(param2)
               {
                  this.var_28.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(-1));
               }
               this.refreshViews();
            }
         }
