package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1492:int = 13421772;
      
      private static const const_1493:int = 10275685;
      ...
      protected var var_926:int = 0;
      
      protected var var_741:BitmapData;
      
      protected var var_2532:int;
      
      protected var var_1696:Boolean;
      
      protected var var_2238:Boolean;
      
      protected var var_3031:BitmapData;
      
      private var var_1500:Boolean;
      
      private const const_2059:Number = 1;
      
      private const const_2058:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2394 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3031 = param6;
         this.var_2238 = param7;
         this._items = new Map();
         this.var_2236 = param2;
         this._category = param3;
         this.var_2237 = param8;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2236 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1552));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2237);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_888)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2058;
               _loc1_.blend = this.const_2058;
            }
            else
            {
               this._window.blend = this.const_2059;
               _loc1_.blend = this.const_2059;
            }
         }
         this.var_1473.color = !!this.var_1500 ? uint(const_1493) : uint(const_1492);
         this.var_2394.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2238 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3031;
               _loc5_.visible = true;
            }
            else
            {
