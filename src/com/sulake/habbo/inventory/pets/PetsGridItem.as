package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_46:
               this.var_1669.setSelectedGridItem(this);
               this.var_1670 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1670 = false;
                  this.var_1669.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1473.color = !!this.var_1469 ? uint(const_1493) : uint(const_1492);
         this.var_2394.visible = param1;
      }
