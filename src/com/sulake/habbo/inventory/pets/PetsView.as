package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1088:int = 1;
      
      private const const_1118:int = 2;
      ...
      private var var_236:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_219 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_236);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_563.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_219.removeGridItem(_loc2_.window);
         if(this.var_236 == _loc2_)
         {
            this.var_236 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_563 == null || this.var_563.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_563.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_563.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_219.addGridItem(_loc2_.window);
            this.var_563.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_236.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_236 != null)
         {
            this.var_236.setSelected(false);
         }
         this.var_236 = param1;
         if(this.var_236 != null)
         {
            this.var_236.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1088;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1118;
         }
         else
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_399) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_459) > 0;
