package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_133 && this.var_28.isVisible)
         {
            this._view.updateCategoryButtons();
            this.var_28.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         var _loc3_:FurniModel = this.var_28.furniModel;
         if(_loc3_ != null)
         {
            _loc3_.switchCategory(param1);
            this.var_28.toggleInventoryPage(InventoryCategory.const_78,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(this.var_28.roomSession.isRoomOwner)
         {
            this.var_1839 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_210,_loc3_.figureString);
            this.var_28.closeView();
            return;
         }
         if(!this.var_28.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1839 && param1.type == RoomEngineObjectEvent.const_140)
         {
      ...
      {
         return this.var_28.roomSession;
      }
