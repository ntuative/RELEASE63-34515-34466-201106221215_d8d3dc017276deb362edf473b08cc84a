package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1155:uint = 4284532064;
      
      private static const const_1156:uint = 2577770;
      ...
      private var var_728:ItemPopupCtrl;
      ...
      private var var_1118:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_728 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(this.var_2147 == null)
         {
            this.var_2147 = this.createMinimizedWindow();
         }
         if(!this.var_2961)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1155) : uint(const_1156);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1155) : uint(const_1156);
            }
         ...
         if(this.var_80)
         {
            ...
            switch(this.var_20.state)
            {
               ...
               case TradingModel.const_336:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_549:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_299:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function removeSelection() : void
      {
         if(this.var_1118)
         {
            this.var_1118.isSelected = false;
            this.var_1118 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_728.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_544);
            this.var_728.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_728.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_204.push(param4);
            this.var_204.push(param1);
            this.var_204.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_204.length > 0)
         {
            _loc2_ = this.var_204.pop();
            _loc3_ = this.var_204.pop();
            _loc4_ = uint(this.var_204.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_728.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_544);
               }
            }
            else
            {
               this.var_204.push(_loc4_);
