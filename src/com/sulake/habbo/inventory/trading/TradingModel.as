package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1758:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1298 = false;
         this.var_1961 = param6;
         this.var_776 = true;
         this.state = const_227;
         this.var_59.setup(param1,param3,param4,param6);
         this.var_59.updateItemList(this.var_831);
         this.var_59.updateItemList(this.var_1559);
      ...
      public function close() : void
      {
         if(this.var_776)
         {
            if(this._state != const_208 && this._state != const_299)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_832 + " OTHER: " + this.var_1298);
         ...
         {
            case const_208:
               if(param1 == const_227 || param1 == const_299)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_59.alertPopup(TradingView.const_1260);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_831)
            {
               this.var_832 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1298 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_59.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_831)
            {
               this.var_59.alertPopup(TradingView.const_1276);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_283.length < const_1758)
         {
