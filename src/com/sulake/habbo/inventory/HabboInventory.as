package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2359:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_74,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_628,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_66.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_66.getValue(InventorySubCategory.const_346));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_66.getValue(InventoryCategory.const_163));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_66.getValue(InventoryCategory.const_245));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_66.getValue(InventorySubCategory.const_1170));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_66.getValue(InventoryCategory.const_133));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_66.getValue(InventoryCategory.const_419) as MarketplaceModel;
      }
      ...
      {
         this.var_419 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_74,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_628,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               this.var_1241 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_628:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_419 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_66.add(InventoryCategory.const_419,_loc1_);
         ...
         this.var_66.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_419);
         this.var_66.add(InventoryCategory.const_245,_loc3_);
         ...
         this.var_66.add(InventoryCategory.const_163,_loc4_);
         ...
         this.var_66.add(InventorySubCategory.const_346,_loc5_);
         ...
         this.var_66.add(InventorySubCategory.const_1170,_loc6_);
         ...
         this.var_66.add(InventoryCategory.const_133,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1116.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1116.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1116.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2359);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_310));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2954)
         {
            this.var_2954 = _loc1_;
