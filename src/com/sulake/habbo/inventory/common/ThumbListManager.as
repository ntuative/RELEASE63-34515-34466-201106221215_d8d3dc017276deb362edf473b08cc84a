package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1645:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_707 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_707.width;
         this.var_105 = this.var_707.height;
         this.var_1363 = param5;
         this.var_1099 = param6;
         this.var_259 = Math.floor(this.var_1363 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1363,this.var_1099);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_708 = this.resolveRowCountFromList();
         if(this.var_708 == 0)
         {
            this.var_29 = new BitmapData(this.var_1363,this.var_1099);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_259 * this._thumbWidth,this.var_1363),Math.max(this.var_708 * this.var_105,this.var_1099),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_708)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_259 && this.var_29.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_259 - 1),this.var_105);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_259 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_259 - 1),this.var_29.height - this.var_105);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1645.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_259));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_259 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_259);
         var _loc3_:int = param1 % this.var_259;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_259)
         {
            return;
         }
         if(param1.y >= this.var_708)
         {
            return;
         }
         var _loc4_:int = this.var_259 - param1.x - 1;
         ...
         if(this.var_29.height < this.var_1099)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1099);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_707.width,this.var_707.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_707.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_707,this.var_707.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
