package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1223:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1223 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1223.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_305 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_74;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1496));
         this.var_1497.add(this.var_1496,getTimer());
         ++this.var_1496;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1497.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
      ...
      {
         return this.var_1223 as IUserDataManager;
      }
