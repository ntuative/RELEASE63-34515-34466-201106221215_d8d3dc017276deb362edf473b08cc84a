package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1046:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1463:String = "sendAccessTokenToServer";
      
      private static const const_1462:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1463,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1462,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1046);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1046);
         }
      }
