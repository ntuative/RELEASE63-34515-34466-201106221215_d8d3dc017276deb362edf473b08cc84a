package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator extends IndicatorBase
   {
      ...
      private static const const_1495:uint = 4291993382;
      
      private static const const_1496:uint = 4290807040;
      
      private static const const_475:Array = ["icon_credit_0_png","icon_credit_1_png","icon_credit_2_png","icon_credit_3_png","icon_credit_4_png","icon_credit_5_png","icon_credit_6_png"];
      ...
      public function CreditsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog)
      {
         ...
         this.iconAnimationSequence = const_475;
         this.iconAnimationDelay = 50;
         createWindow("purse_indicator_credits_xml",const_475[0]);
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1793 != -1)
         {
            if(this.var_1793 > param1.balance)
            {
