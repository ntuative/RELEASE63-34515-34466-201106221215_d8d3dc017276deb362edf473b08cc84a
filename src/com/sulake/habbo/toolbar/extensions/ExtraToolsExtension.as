package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1717:uint = 16777215;
      
      private static const const_1716:uint = 12247545;
      
      private static const const_1714:String = "HELP";
      
      private static const const_1715:String = "ROOMINFO";
      ...
      private var var_394:IWindow;
      
      private var var_733:IWindowContainer;
      
      private const const_913:int = 42;
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_394 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_67.removeListItem(this.var_394);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_394,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_911;
         _loc3_.y = this.const_913;
      ...
      private function showConfirmation() : void
      {
         if(!this.var_733)
         {
            this.var_733 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1714);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1715);
               break;
            case "confirm":
               if(false)
               {
