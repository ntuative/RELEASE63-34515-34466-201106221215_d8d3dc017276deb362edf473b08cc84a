package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1458:Point = new Point(3,3);
      
      private static const const_1456:uint = 7433577;
      
      private static const const_1459:uint = 5723213;
      
      private static const const_471:String = "_hover";
      
      private static const const_470:String = "_normal";
      
      private static const const_469:int = 5;
      
      private static const const_1461:int = 600;
      
      private static const const_1454:int = 80;
      
      private static const const_1460:int = 74;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1458;
         this._window.addEventListener(WindowEvent.const_564,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_470);
         }
         ...
         this.var_211 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_211);
         var _loc14_:ITextWindow = this.var_211.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_211.x = _loc13_.width - this.var_211.width - const_469;
         this.var_211.y = const_469;
         this.var_2347 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1461;
         if(!param1 && _loc2_ == this.var_1457)
         {
            return;
         }
         this.var_1457 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1460) : int(const_1454);
         var _loc4_:int = !!_loc2_ ? int(const_1457) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1453 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1455;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_211 != null && this.var_2347)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_797:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_1027:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_471);
               this.setIconBgHoverState(_loc3_,const_471);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_471 ? this.var_1459 : this.var_1458;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_471)
         {
            param1.color = const_1456;
         }
         else
         {
            param1.color = const_1459;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1457 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1457 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1458 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1459)
         {
            this.var_1459.dispose();
         }
         this.var_1459 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_954.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_469;
            _loc2_.y = const_469;
            this.var_954.add(param1,_loc2_);
         }
         return _loc2_;
      }
