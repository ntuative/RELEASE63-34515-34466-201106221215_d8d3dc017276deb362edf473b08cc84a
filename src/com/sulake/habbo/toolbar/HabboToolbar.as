package com.sulake.habbo.toolbar
{
   ...
   import com.sulake.habbo.toolbar.extensions.ClubStatusBarExtension;
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_780:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1476:PurseExtension;
      
      private var var_1477:ClubStatusBarExtension;
      ...
      {
         this.var_13 = IHabboInventory(param2);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_303 && this._windowManager && this._config && this._localization && this.var_13 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_780 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
            if(this._config.getBoolean("club.status.bar.enabled",false))
            {
               this.var_1477 = new ClubStatusBarExtension(this._windowManager,assets,events,this._config,this._localization,this.var_13,this._catalog,this._connection);
            }
            this.var_1476 = new PurseExtension(this._windowManager,this._assetLibrary,events,this._config,this._catalog);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_780.showRoomInfo();
         }
         else
         {
            this.var_780.hideRoomInfo();
         }
      }
