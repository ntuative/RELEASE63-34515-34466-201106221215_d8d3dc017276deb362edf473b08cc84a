package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1133:Number = 60;
      
      private static const const_1661:Number = 50;
      ...
      private var var_583:Point;
      
      private var var_296:BitmapDataCache;
      
      private var var_698:RoomObjectCache;
      
      private var var_582:Array;
      
      private var var_696:Array;
      
      private var var_1631:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2859:Number = -1.0E7;
      
      private var var_2857:Number = -1.0E7;
      ...
      private var var_548:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_698 = new RoomObjectCache(_loc6_);
         this.var_773 = new ColorTransform();
         this.var_694 = new Matrix();
      ...
      {
         this.var_583.x -= param1 - this.var_695;
         this.var_695 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_583.y -= param1 - this.var_699;
         this.var_699 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1102 = true;
            if(this.var_154 != null && !this.var_295.contains(this.var_154))
            {
               this.var_295.addChild(this.var_154);
               this.var_114.mask = this.var_154;
            }
         }
         else if(!param1 && this.var_1102)
         {
            this.var_1102 = false;
            if(this.var_154 != null && this.var_295.contains(this.var_154))
            {
               this.var_295.removeChild(this.var_154);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_696.length)
            {
               this.cleanSprite(this.var_696[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_696 = [];
         }
      ...
      {
         this.var_698.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2075 = !this.var_2075;
         ...
         if(this.var_580 != this.var_2858 || this.var_581 != this.var_2861)
         {
            _loc8_ = true;
         }
         if(this.var_114.x != this.var_695 || this.var_114.y != this.var_699)
         {
            this.var_114.x = this.var_695;
            this.var_114.y = this.var_699;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_582.sortOn("z",0 | 0);
         if(_loc5_ < this.var_582.length)
         {
            this.var_582.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_582[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2858 = this.var_580;
         this.var_2861 = this.var_581;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1630 > 0)
         {
            _loc2_ = param1 - this.var_1630;
            if(_loc2_ > const_1133 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2856 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_873;
               if(this.var_873 == const_393 + 1)
               {
                  this.var_548 = _loc2_;
                  this.var_2076 = this.var_2862;
               }
               else if(this.var_873 > const_393 + 1)
               {
                  _loc3_ = Number(this.var_873 - const_393);
                  this.var_548 = this.var_548 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2076 = this.var_2076 * (_loc3_ - 1) / _loc3_ + Number(this.var_2862) / _loc3_;
                  if(this.var_873 > const_393 + const_1660)
                  {
                     this.var_873 = const_393;
                     if(!this.var_1352 && this.var_548 > const_1133)
                     {
                        this.var_1352 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1352 && this.var_548 < const_1661)
                     {
                        this.var_1352 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_698.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_698.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2075 && this.var_1352);
         ...
         _loc13_ += int(this.var_580 / 2);
         _loc14_ += int(this.var_581 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_695;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_699;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_582.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_695;
                     _loc17_.y = _loc20_ - this.var_699;
      ...
      {
         if(param1 < this.var_580 && param1 + param3 >= 0 && (param2 < this.var_581 && param2 + param4 >= 0))
         {
            if(!this.var_3072)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_580)
         {
            param3 -= this.var_580 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_581)
         {
            param4 -= this.var_581 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2860)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1090)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_696.length > 0)
         {
            _loc3_ = this.var_696.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1090)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_874 || this.var_874 == 0)
         {
            _loc4_ = this.var_1090 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_582[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_694.identity();
            if(flipH)
            {
               this.var_694.scale(-1,1);
               this.var_694.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_694.scale(1,-1);
               this.var_694.translate(0,data.height);
            }
            finalData.draw(data,this.var_694);
            if(name.length > 0)
            {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_695;
         param2 -= this.var_699;
         this.var_583.x = param1;
         this.var_583.y = param2;
         if(this.var_1353 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2073;
         }
         this.var_2073 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1353;
         return this.var_2073;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_580 / 2;
         var _loc12_:Number = param2 - this.var_581 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2074,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_697.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_697.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2859 || param2 != this.var_2857)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_697.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_697.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_410.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1631.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1353 == 0)
         {
            this.checkMouseHits(this.var_583.x,this.var_583.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1353 = 0;
         ++this.var_2074;
      }
