package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1471:int = 128;
      
      private var var_1470:Boolean = false;
      
      private var var_3053:Point;
      ...
      {
         if(param1 != this.var_1792 || param2 != this.var_1791)
         {
      ...
      {
         if(this.var_1471 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_210 || param2 >= this._height)
         {
            return false;
         }
