package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1244:Number = 32;
      ...
      private var var_1165:Vector3d;
      
      private var var_437:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1164:Vector3d;
      ...
      private var var_3049:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1165 = new Vector3d();
         this.var_437 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1164 = new Vector3d();
         this.var_1737 = 1;
         this.var_1739 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1738 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_437.assign(this.var_103);
         this.var_437.x *= this.var_436;
         this.var_437.y *= this.var_435;
         this.var_437.z *= this.var_433;
         return this.var_437;
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1737)
         {
            this.var_436 = param1 * this.var_1737;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_435 != param1 * this.var_1739)
         {
            this.var_435 = param1 * this.var_1739;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_433 != param1 * this.var_1738)
         {
            this.var_433 = param1 * this.var_1738;
            ++this.var_168;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_103.x /= this.var_436;
         this.var_103.y /= this.var_435;
         this.var_103.z /= this.var_433;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_434.x;
         var _loc3_:Number = this.var_434.y;
         var _loc4_:Number = this.var_434.z;
         this.var_434.assign(param1);
         this._direction.assign(param1);
         if(this.var_434.x != _loc2_ || this.var_434.y != _loc3_ || this.var_434.z != _loc4_)
         {
            ++this.var_168;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1165.assign(this.var_176);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1164.assign(_loc22_);
         }
         else
         {
            this.var_1164.assign(_loc17_);
         }
         ++this.var_168;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_436;
         _loc2_.y *= this.var_435;
         _loc2_.z *= this.var_433;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1164);
         if(_loc3_ < this.var_3048 || _loc3_ > this.var_3049)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_435;
            _loc2_.z *= this.var_433;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1164);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_103.x * this.var_436,this.var_103.y * this.var_435,this.var_103.z * this.var_433);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_176;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_436,param2.y * this.var_435,param2.z * this.var_433);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_436,param3.y * this.var_435,param3.z * this.var_433);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_436,param4.y * this.var_435,param4.z * this.var_433);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1244;
         }
         else
         {
            this.scale = const_507;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_507;
      }
