package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1036:Number = 0.71;
      ...
      private var var_1426:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1426 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1426 && !this.var_1426.disposed)
                  {
                     this.var_1426.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1036 + this.var_26.getNumberOfFilesLoaded() / _loc11_ * const_1036;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
